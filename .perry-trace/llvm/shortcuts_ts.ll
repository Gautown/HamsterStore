...
@shortcuts_ts_.str.0.bytes = private unnamed_addr constant [2 x i8] c"f\00"
@shortcuts_ts_.str.1.bytes = private unnamed_addr constant [2 x i8] c"q\00"
@shortcuts_ts_.str.2.bytes = private unnamed_addr constant [3 x i8] c"f1\00"
@shortcuts_ts_.str.3.bytes = private unnamed_addr constant [27 x i8] c"[shortcut] \E5\BF\AB\E6\8D\B7\E9\94\AE\E9\80\80\E5\87\BA\00"
@.str.0 = private unnamed_addr constant [14 x i8] c"bindShortcuts\00"
@.str.1 = private unnamed_addr constant [370 x i8] c"function bindShortcuts() {\0A  // Ctrl+F \E2\80\94 \E6\90\9C\E7\B4\A2\EF\BC\88ProjectBrowser \E7\9A\84\E6\90\9C\E7\B4\A2\E6\A1\86\E5\B7\B2\E6\8F\90\E4\BE\9B\E6\AD\A4\E5\8A\9F\E8\83\BD\EF\BC\89\0A    addKeyboardShortcut(\22f\22, 1, () => {});\0A\0A    // Ctrl+Q \E2\80\94 \E9\80\80\E5\87\BA\0A    addKeyboardShortcut(\22q\22, 1, () => {\0A      console.log(\22[shortcut] \E5\BF\AB\E6\8D\B7\E9\94\AE\E9\80\80\E5\87\BA\22);\0A      process.exit(0);\0A    });\0A\0A    // F1 \E2\80\94 \E5\B8\AE\E5\8A\A9\EF\BC\88\E9\9D\99\E9\BB\98\EF\BC\89\0A    addKeyboardShortcut(\22f1\22, 0, () => {});\0A}\00"
@.str.2 = private unnamed_addr constant [9 x i8] c"() => {}\00"
@.str.3 = private unnamed_addr constant [86 x i8] c"() => {\0A      console.log(\22[shortcut] \E5\BF\AB\E6\8D\B7\E9\94\AE\E9\80\80\E5\87\BA\22);\0A      process.exit(0);\0A    }\00"
@.str.4 = private unnamed_addr constant [9 x i8] c"() => {}\00"
...
@__perry_init_done_shortcuts_ts = internal global i8 0
@shortcuts_ts_.str.0.handle = internal global double 0.0
@shortcuts_ts_.str.1.handle = internal global double 0.0
@shortcuts_ts_.str.2.handle = internal global double 0.0
@shortcuts_ts_.str.3.handle = internal global double 0.0
...
declare void @perry_ui_add_keyboard_shortcut(i64, double, double)

define double @perry_fn_shortcuts_ts__bindShortcuts() alwaysinline {
entry.0:
  %r1 = load double, ptr @shortcuts_ts_.str.0.handle
  %r2 = call i64 @js_get_string_pointer_unified(double %r1)
  %r3 = call i64 @js_closure_alloc_singleton(ptr @perry_closure_shortcuts_ts__1)
  %r4 = or i64 %r3, 9222527611924643840
  %r5 = bitcast i64 %r4 to double
  call void @perry_ui_add_keyboard_shortcut(i64 %r2, double 1.0, double %r5)
  %r6 = load double, ptr @shortcuts_ts_.str.1.handle
  %r7 = call i64 @js_get_string_pointer_unified(double %r6)
  %r8 = call i64 @js_closure_alloc_singleton(ptr @perry_closure_shortcuts_ts__2)
  %r9 = or i64 %r8, 9222527611924643840
  %r10 = bitcast i64 %r9 to double
  call void @perry_ui_add_keyboard_shortcut(i64 %r7, double 1.0, double %r10)
  %r11 = load double, ptr @shortcuts_ts_.str.2.handle
  %r12 = call i64 @js_get_string_pointer_unified(double %r11)
  %r13 = call i64 @js_closure_alloc_singleton(ptr @perry_closure_shortcuts_ts__3)
  %r14 = or i64 %r13, 9222527611924643840
  %r15 = bitcast i64 %r14 to double
  call void @perry_ui_add_keyboard_shortcut(i64 %r12, double 0.0, double %r15)
  ret double 0x7FFC000000000001
}

define double @perry_closure_shortcuts_ts__1(i64 %this_closure) {
entry.0:
  ret double 0x7FFC000000000001
}

define double @perry_closure_shortcuts_ts__2(i64 %this_closure) {
entry.0:
  %r1 = load double, ptr @shortcuts_ts_.str.3.handle
...
define double @perry_closure_shortcuts_ts__3(i64 %this_closure) {
entry.0:
  ret double 0x7FFC000000000001
}

define double @__perry_wrap_perry_fn_shortcuts_ts__bindShortcuts(i64 %this_closure) {
entry.0:
...
define void @shortcuts_ts__init() {
entry.0:
  %r1 = load i8, ptr @__perry_init_done_shortcuts_ts
  %r2 = icmp ne i8 %r1, 0
...
guard.do.2:
  store i8 1, ptr @__perry_init_done_shortcuts_ts
  call void @shortcuts_ts__init_body()
  ret void
}

define external void @shortcuts_ts__init_body() {
entry.0:
  call void @js_gc_write_barriers_emitted(i32 1)
  call void @__perry_init_strings_shortcuts_ts()
  ret void
}

define void @__perry_init_strings_shortcuts_ts_chunk0() {
entry.0:
  %r1 = call i64 @js_string_from_bytes(ptr @shortcuts_ts_.str.0.bytes, i32 1)
  %r2 = call double @js_nanbox_string(i64 %r1)
  store double %r2, ptr @shortcuts_ts_.str.0.handle
  %r3 = ptrtoint ptr @shortcuts_ts_.str.0.handle to i64
  call void @js_gc_register_global_root(i64 %r3)
  %r4 = call i64 @js_string_from_bytes(ptr @shortcuts_ts_.str.1.bytes, i32 1)
  %r5 = call double @js_nanbox_string(i64 %r4)
  store double %r5, ptr @shortcuts_ts_.str.1.handle
  %r6 = ptrtoint ptr @shortcuts_ts_.str.1.handle to i64
  call void @js_gc_register_global_root(i64 %r6)
  %r7 = call i64 @js_string_from_bytes(ptr @shortcuts_ts_.str.2.bytes, i32 2)
  %r8 = call double @js_nanbox_string(i64 %r7)
  store double %r8, ptr @shortcuts_ts_.str.2.handle
  %r9 = ptrtoint ptr @shortcuts_ts_.str.2.handle to i64
  call void @js_gc_register_global_root(i64 %r9)
  %r10 = call i64 @js_string_from_bytes(ptr @shortcuts_ts_.str.3.bytes, i32 26)
  %r11 = call double @js_nanbox_string(i64 %r10)
  store double %r11, ptr @shortcuts_ts_.str.3.handle
  %r12 = ptrtoint ptr @shortcuts_ts_.str.3.handle to i64
  call void @js_gc_register_global_root(i64 %r12)
  call void @js_register_function_name(ptr @__perry_wrap_perry_fn_shortcuts_ts__bindShortcuts, ptr @.str.0, i32 13)
  call void @js_register_function_source(ptr @__perry_wrap_perry_fn_shortcuts_ts__bindShortcuts, ptr @.str.1, i32 369)
  call void @js_register_function_source(ptr @perry_closure_shortcuts_ts__3, ptr @.str.2, i32 8)
  call void @js_register_function_source(ptr @perry_closure_shortcuts_ts__2, ptr @.str.3, i32 85)
  call void @js_register_function_source(ptr @perry_closure_shortcuts_ts__1, ptr @.str.4, i32 8)
  call void @js_register_closure_arity(ptr @perry_closure_shortcuts_ts__1, i32 0)
  call void @js_register_closure_arity(ptr @perry_closure_shortcuts_ts__2, i32 0)
  call void @js_register_closure_arity(ptr @perry_closure_shortcuts_ts__3, i32 0)
  call void @js_register_closure_length(ptr @perry_closure_shortcuts_ts__1, i32 0)
  call void @js_register_closure_length(ptr @perry_closure_shortcuts_ts__2, i32 0)
  call void @js_register_closure_length(ptr @perry_closure_shortcuts_ts__3, i32 0)
  call void @js_register_closure_arrow_function(ptr @perry_closure_shortcuts_ts__1)
  call void @js_register_closure_arrow_function(ptr @perry_closure_shortcuts_ts__2)
  call void @js_register_closure_arrow_function(ptr @perry_closure_shortcuts_ts__3)
  call void @js_register_closure_arity(ptr @__perry_wrap_perry_fn_shortcuts_ts__bindShortcuts, i32 0)
  call void @js_register_closure_length(ptr @__perry_wrap_perry_fn_shortcuts_ts__bindShortcuts, i32 0)
  call void @js_register_closure_strict_function(ptr @__perry_wrap_perry_fn_shortcuts_ts__bindShortcuts)
  call void @js_register_closure_strict_function(ptr @perry_closure_shortcuts_ts__1)
  call void @js_register_closure_strict_function(ptr @perry_closure_shortcuts_ts__2)
  call void @js_register_closure_strict_function(ptr @perry_closure_shortcuts_ts__3)
  ret void
}

define void @__perry_init_strings_shortcuts_ts() {
entry.0:
  call void @__perry_init_strings_shortcuts_ts_chunk0()
  ret void
}
