...
@cli_launcher_ts_.str.0.bytes = private unnamed_addr constant [32 x i8] c"[cli-launcher] CLI \E5\B7\B2\E5\9C\A8\E8\BF\90\E8\A1\8C\00"
@cli_launcher_ts_.str.1.bytes = private unnamed_addr constant [13 x i8] c"start_cli.ts\00"
@cli_launcher_ts_.str.2.bytes = private unnamed_addr constant [14 x i8] c"cli_start.bat\00"
@cli_launcher_ts_.str.3.bytes = private unnamed_addr constant [13 x i8] c"node_modules\00"
@cli_launcher_ts_.str.4.bytes = private unnamed_addr constant [5 x i8] c".bin\00"
@cli_launcher_ts_.str.5.bytes = private unnamed_addr constant [8 x i8] c"tsx.cmd\00"
@cli_launcher_ts_.str.6.bytes = private unnamed_addr constant [45 x i8] c"[cli-launcher] \E4\BD\BF\E7\94\A8 npx tsx.cmd \E5\90\AF\E5\8A\A8 CLI\00"
@cli_launcher_ts_.str.7.bytes = private unnamed_addr constant [8 x i8] c"cmd.exe\00"
@cli_launcher_ts_.str.8.bytes = private unnamed_addr constant [3 x i8] c"/C\00"
@cli_launcher_ts_.str.9.bytes = private unnamed_addr constant [5 x i8] c"pipe\00"
@cli_launcher_ts_.str.10.bytes = private unnamed_addr constant [41 x i8] c"[cli-launcher] CLI \E8\BF\9B\E7\A8\8B\E5\B7\B2\E5\90\AF\E5\8A\A8 (pid=\00"
@cli_launcher_ts_.str.11.bytes = private unnamed_addr constant [4 x i8] c"pid\00"
@cli_launcher_ts_.str.12.bytes = private unnamed_addr constant [2 x i8] c")\00"
@cli_launcher_ts_.str.13.bytes = private unnamed_addr constant [32 x i8] c"[cli-launcher] \E6\97\A0\E6\B3\95\E5\90\AF\E5\8A\A8CLI \00"
@cli_launcher_ts_.str.14.bytes = private unnamed_addr constant [8 x i8] c"message\00"
@cli_launcher_ts_.str.15.bytes = private unnamed_addr constant [51 x i8] c"[cli-launcher] tsx.cmd \E4\B8\8D\E5\AD\98\E5\9C\A8\EF\BC\8C\E8\B7\B3\E8\BF\87CLI\E5\90\AF\E5\8A\A8\00"
@cli_launcher_ts_.str.16.bytes = private unnamed_addr constant [72 x i8] c"[cli-launcher] \E8\AF\B7\E5\9C\A8\E7\BB\88\E7\AB\AF\E6\89\A7\E8\A1\8C\EF\BC\9Anpm install && npx tsx start_cli.ts\00"
@cli_launcher_ts_.str.17.bytes = private unnamed_addr constant [5 x i8] c"5678\00"
@cli_launcher_ts_.str.18.bytes = private unnamed_addr constant [9 x i8] c"API_PORT\00"
@cli_launcher_ts_.str.19.bytes = private unnamed_addr constant [5 x i8] c"INFO\00"
@cli_launcher_ts_.str.20.bytes = private unnamed_addr constant [10 x i8] c"LOG_LEVEL\00"
@cli_launcher_ts_.str.21.bytes = private unnamed_addr constant [4 x i8] c"env\00"
@cli_launcher_ts_.str.22.bytes = private unnamed_addr constant [4 x i8] c"cwd\00"
@cli_launcher_ts_.str.23.bytes = private unnamed_addr constant [6 x i8] c"stdio\00"
@perry_class_keys_packed_cli_launcher_ts__0 = private unnamed_addr constant [15 x i8] c"env\00cwd\00stdio\00\00"
@.str.0 = private unnamed_addr constant [16 x i8] c"startCliService\00"
@.str.1 = private unnamed_addr constant [15 x i8] c"stopCliService\00"
@.str.2 = private unnamed_addr constant [8 x i8] c"cliPath\00"
@.str.3 = private unnamed_addr constant [1111 x i8] c"function startCliService() {\0A  if (cliProcess) {\0A    console.log(\22[cli-launcher] CLI \E5\B7\B2\E5\9C\A8\E8\BF\90\E8\A1\8C\22);\0A    return;\0A  }\0A\0A  const cliScript = join(process.cwd(), \22start_cli.ts\22);\0A  const batchFile = join(process.cwd(), \22cli_start.bat\22);\0A  const env: any = { ...process.env, API_PORT: \225678\22, LOG_LEVEL: \22INFO\22 };\0A\0A  // \E6\A3\80\E6\9F\A5\E6\98\AF\E5\90\A6\E6\9C\89 start.bat\EF\BC\88\E6\8E\A8\E8\8D\90\E7\94\A8 start.bat \E9\A2\84\E5\85\88\E5\90\AF\E5\8A\A8\EF\BC\89\0A  const npmBin = join(process.cwd(), \22node_modules\22, \22.bin\22, \22tsx.cmd\22);\0A\0A  if (existsSync(npmBin)) {\0A    console.log(\22[cli-launcher] \E4\BD\BF\E7\94\A8 npx tsx.cmd \E5\90\AF\E5\8A\A8 CLI\22);\0A    try {\0A      const { spawn } = require(\22node:child_process\22);\0A      cliProcess = spawn(\22cmd.exe\22, [\22/C\22, npmBin, cliScript], {\0A        env,\0A        cwd: process.cwd(),\0A        stdio: \22pipe\22,\0A      });\0A      console.log(`[cli-launcher] CLI \E8\BF\9B\E7\A8\8B\E5\B7\B2\E5\90\AF\E5\8A\A8 (pid=${cliProcess?.pid})`);\0A    } catch (err: any) {\0A      console.log(\22[cli-launcher] \E6\97\A0\E6\B3\95\E5\90\AF\E5\8A\A8CLI \22 + err.message);\0A    }\0A  } else {\0A    console.log(\22[cli-launcher] tsx.cmd \E4\B8\8D\E5\AD\98\E5\9C\A8\EF\BC\8C\E8\B7\B3\E8\BF\87CLI\E5\90\AF\E5\8A\A8\22);\0A    console.log(\22[cli-launcher] \E8\AF\B7\E5\9C\A8\E7\BB\88\E7\AB\AF\E6\89\A7\E8\A1\8C\EF\BC\9Anpm install && npx tsx start_cli.ts\22);\0A  }\0A}\00"
@.str.4 = private unnamed_addr constant [76 x i8] c"function stopCliService() {\0A  // no-op: perry \E7\BC\96\E8\AF\91\E7\89\88\E4\B8\8D\E7\AE\A1\E7\90\86\E5\AD\90\E8\BF\9B\E7\A8\8B\0A}\00"
@.str.5 = private unnamed_addr constant [77 x i8] c"function cliPath(): string {\0A  return join(process.cwd(), \22start_cli.ts\22);\0A}\00"
...
@perry_class_keys_cli_launcher_ts____AnonShape_4402c0dde8651b90 = internal global i64 0
@perry_global_cli_launcher_ts__0 = global double 0x7FFC000000000001
@perry_ic_1 = private global [2 x i64] zeroinitializer
@perry_ic_3 = private global [2 x i64] zeroinitializer
@perry_node_submod_str_perry_fn_cli_launcher_ts__startCliService_0 = private unnamed_addr constant [5 x i8] c"file\00"
@__perry_extern_closure_api_ts__setApiPort = internal constant { ptr, i32, i32 } { ptr @__perry_wrap_extern_api_ts__setApiPort, i32 0, i32 1129074515 }
@__perry_init_done_cli_launcher_ts = internal global i8 0
@cli_launcher_ts_.str.0.handle = internal global double 0.0
@cli_launcher_ts_.str.1.handle = internal global double 0.0
@cli_launcher_ts_.str.2.handle = internal global double 0.0
@cli_launcher_ts_.str.3.handle = internal global double 0.0
@cli_launcher_ts_.str.4.handle = internal global double 0.0
@cli_launcher_ts_.str.5.handle = internal global double 0.0
@cli_launcher_ts_.str.6.handle = internal global double 0.0
@cli_launcher_ts_.str.7.handle = internal global double 0.0
@cli_launcher_ts_.str.8.handle = internal global double 0.0
@cli_launcher_ts_.str.9.handle = internal global double 0.0
@cli_launcher_ts_.str.10.handle = internal global double 0.0
@cli_launcher_ts_.str.11.handle = internal global double 0.0
@cli_launcher_ts_.str.12.handle = internal global double 0.0
@cli_launcher_ts_.str.13.handle = internal global double 0.0
@cli_launcher_ts_.str.14.handle = internal global double 0.0
@cli_launcher_ts_.str.15.handle = internal global double 0.0
@cli_launcher_ts_.str.16.handle = internal global double 0.0
@cli_launcher_ts_.str.17.handle = internal global double 0.0
@cli_launcher_ts_.str.18.handle = internal global double 0.0
@cli_launcher_ts_.str.19.handle = internal global double 0.0
@cli_launcher_ts_.str.20.handle = internal global double 0.0
@cli_launcher_ts_.str.21.handle = internal global double 0.0
@cli_launcher_ts_.str.22.handle = internal global double 0.0
@cli_launcher_ts_.str.23.handle = internal global double 0.0
@perry_typed_shape_mask_cli_launcher_ts____AnonShape_4402c0dde8651b90 = private unnamed_addr constant [1 x i64] [i64 7]
...
declare double @perry_fn_api_ts__setApiPort(double)
declare void @api_ts__init()

define double @perry_fn_cli_launcher_ts__startCliService() #1 {
entry.0:
  %r1 = alloca i64
  ...
  %r20 = alloca double
  store double 0x7FFC000000000001, ptr %r20
  %r31 = alloca double
  store double 0x7FFC000000000001, ptr %r31
  %r43 = alloca double
  store double 0x7FFC000000000001, ptr %r43
  %r88 = alloca ptr
  %r89 = call ptr @js_inline_arena_state()
  store ptr %r89, ptr %r88
  %r119 = alloca i64
  %r120 = load i64, ptr @perry_class_keys_cli_launcher_ts____AnonShape_4402c0dde8651b90
  store i64 %r120, ptr %r119
  %r204 = alloca [32 x double]
  %r215 = alloca double
  %r3 = load double, ptr @perry_global_cli_launcher_ts__0
  %r4 = call i32 @js_is_truthy(double %r3)
  %r5 = icmp ne i32 %r4, 0
  br i1 %r5, label %if.then.1, label %if.else.2

if.then.1:
  %r6 = load double, ptr @cli_launcher_ts_.str.0.handle
...
if.merge.3:
  %r10 = call i64 @js_process_cwd()
  %r11 = or i64 %r10, 9223090561878065152
  %r12 = bitcast i64 %r11 to double
  %r13 = load double, ptr @cli_launcher_ts_.str.1.handle
  %r14 = and i64 %r11, 281474976710655
  %r15 = bitcast double %r13 to i64
  %r16 = and i64 %r15, 281474976710655
  %r17 = call i64 @js_path_join(i64 %r14, i64 %r16)
  %r18 = or i64 %r17, 9223090561878065152
  %r19 = bitcast i64 %r18 to double
  store double %r19, ptr %r9
  call void @js_shadow_slot_bind(i32 0, ptr %r9)
  call void @js_shadow_slot_set(i32 0, i64 %r18)
  %r21 = call i64 @js_process_cwd()
  %r22 = or i64 %r21, 9223090561878065152
  %r23 = bitcast i64 %r22 to double
  %r24 = load double, ptr @cli_launcher_ts_.str.2.handle
  %r25 = and i64 %r22, 281474976710655
  %r26 = bitcast double %r24 to i64
  %r27 = and i64 %r26, 281474976710655
  %r28 = call i64 @js_path_join(i64 %r25, i64 %r27)
  %r29 = or i64 %r28, 9223090561878065152
  %r30 = bitcast i64 %r29 to double
  store double %r30, ptr %r20
  call void @js_shadow_slot_bind(i32 1, ptr %r20)
  call void @js_shadow_slot_set(i32 1, i64 %r29)
  call void @js_shadow_slot_set(i32 1, i64 0)
  %r32 = call i64 @js_closure_alloc(ptr @perry_closure_cli_launcher_ts__3, i32 0)
  %r33 = or i64 %r32, 9222527611924643840
  %r34 = bitcast i64 %r33 to double
  %r35 = call i64 @js_object_alloc(i32 0, i32 0)
  %r36 = or i64 %r35, 9222527611924643840
  %r37 = bitcast i64 %r36 to double
  %r38 = call double @js_implicit_this_set(double 0x7FFC000000000001)
  %r39 = call i64 @js_closure_unbox_callee_checked(double %r34)
  %r40 = call double @js_closure_call1(i64 %r39, double %r37)
  %r41 = call double @js_implicit_this_set(double %r38)
  store double %r40, ptr %r31
  call void @js_shadow_slot_bind(i32 2, ptr %r31)
  %r42 = bitcast double %r40 to i64
  ...
  %r47 = load double, ptr @cli_launcher_ts_.str.3.handle
  ...
  %r54 = load double, ptr @cli_launcher_ts_.str.4.handle
  %r55 = and i64 %r52, 281474976710655
  %r56 = bitcast double %r54 to i64
  %r57 = and i64 %r56, 281474976710655
  %r58 = call i64 @js_path_join(i64 %r55, i64 %r57)
  %r59 = or i64 %r58, 9223090561878065152
  %r60 = bitcast i64 %r59 to double
  %r61 = load double, ptr @cli_launcher_ts_.str.5.handle
  %r62 = and i64 %r59, 281474976710655
  %r63 = bitcast double %r61 to i64
  %r64 = and i64 %r63, 281474976710655
  %r65 = call i64 @js_path_join(i64 %r62, i64 %r64)
  %r66 = or i64 %r65, 9223090561878065152
  %r67 = bitcast i64 %r66 to double
  store double %r67, ptr %r43
  call void @js_shadow_slot_bind(i32 3, ptr %r43)
  call void @js_shadow_slot_set(i32 3, i64 %r66)
  %r68 = load double, ptr %r43
  %r69 = call i32 @js_fs_exists_sync(double %r68)
  %r70 = icmp ne i32 %r69, 0
  %r71 = select i1 %r70, i64 9222246136947933188, i64 9222246136947933187
  %r72 = bitcast i64 %r71 to double
  %r73 = call i32 @js_is_truthy(double %r72)
  %r74 = icmp ne i32 %r73, 0
  br i1 %r74, label %if.then.4, label %if.else.5

if.then.4:
  %r75 = load double, ptr @cli_launcher_ts_.str.6.handle
  %r76 = call i64 @js_array_alloc(i32 1)
  %r77 = call i64 @js_array_push_f64(i64 %r76, double %r75)
  call void @js_console_log_spread(i64 %r77)
  %r78 = call ptr @js_try_push()
  %r79 = call i32 @_setjmp(ptr %r78, ptr null) #0
  %r80 = icmp ne i32 %r79, 0
  br i1 %r80, label %try.catch.8, label %try.body.7

if.else.5:
  %r275 = load double, ptr @cli_launcher_ts_.str.15.handle
  %r276 = call i64 @js_array_alloc(i32 1)
  %r277 = call i64 @js_array_push_f64(i64 %r276, double %r275)
  call void @js_console_log_spread(i64 %r277)
  %r278 = load double, ptr @cli_launcher_ts_.str.16.handle
  %r279 = call i64 @js_array_alloc(i32 1)
  %r280 = call i64 @js_array_push_f64(i64 %r279, double %r278)
  call void @js_console_log_spread(i64 %r280)
  br label %if.merge.6
...
try.body.7:
  %r81 = load double, ptr @cli_launcher_ts_.str.7.handle
  %r82 = call double @js_child_process_validate_command(double %r81, ptr @perry_node_submod_str_perry_fn_cli_launcher_ts__startCliService_0, i32 4)
  %r83 = bitcast double %r81 to i64
  %r84 = and i64 %r83, 281474976710655
  %r85 = load double, ptr @cli_launcher_ts_.str.8.handle
  %r86 = load double, ptr %r43
  %r87 = load double, ptr %r9
  %r90 = load ptr, ptr %r88
  %r91 = getelementptr i8, ptr %r90, i64 8
  %r92 = load i64, ptr %r91
  %r93 = add i64 %r92, 40
  %r94 = getelementptr i8, ptr %r90, i64 16
  %r95 = load i64, ptr %r94
  %r96 = icmp ule i64 %r93, %r95
  br i1 %r96, label %arrlit.fast.10, label %arrlit.slow.11

try.catch.8:
  call void @js_try_end()
  %r214 = call double @js_get_exception()
  call void @js_clear_exception()
  store double %r214, ptr %r215
  %r216 = load double, ptr @cli_launcher_ts_.str.13.handle
  %r217 = load double, ptr %r215
  %r218 = bitcast double %r217 to i64
  %r219 = and i64 %r218, 281474976710655
  %r220 = load double, ptr @cli_launcher_ts_.str.14.handle
  %r221 = bitcast double %r220 to i64
  %r222 = and i64 %r221, 281474976710655
  %r223 = lshr i64 %r218, 48
  %r224 = icmp eq i64 %r223, 32761
  %r225 = icmp eq i64 %r223, 32766
  %r226 = and i64 %r223, 65533
  %r227 = icmp eq i64 %r226, 32765
  br i1 %r224, label %pget.recv_sso.28, label %pget.check_class_ref.34

try.finally.9:
  br label %if.merge.6

arrlit.fast.10:
  store i64 %r93, ptr %r91
  %r97 = load ptr, ptr %r90
  %r98 = getelementptr i8, ptr %r97, i64 %r92
  br label %arrlit.merge.12

arrlit.slow.11:
  %r99 = call ptr @js_inline_arena_slow_alloc(ptr %r90, i64 40, i64 8)
  br label %arrlit.merge.12

arrlit.merge.12:
  %r100 = phi ptr [ %r98, %arrlit.fast.10 ], [ %r99, %arrlit.slow.11 ]
  store i64 172872434177, ptr %r100
  %r101 = getelementptr i8, ptr %r100, i64 8
  store i64 12884901891, ptr %r101
  %r102 = getelementptr i8, ptr %r100, i64 8
  %r103 = ptrtoint ptr %r102 to i64
  %r104 = getelementptr inbounds i8, ptr %r100, i64 16
  store double %r85, ptr %r104
  call void @js_string_addref_if_heap_string(double %r85)
  %r105 = bitcast double %r85 to i64
  call void @js_gc_note_slot_layout(i64 %r103, i32 0, i64 %r105)
  %r106 = getelementptr inbounds i8, ptr %r100, i64 24
  store double %r86, ptr %r106
  call void @js_string_addref_if_heap_string(double %r86)
  %r107 = bitcast double %r86 to i64
  call void @js_gc_note_slot_layout(i64 %r103, i32 1, i64 %r107)
  %r108 = getelementptr inbounds i8, ptr %r100, i64 32
  store double %r87, ptr %r108
  call void @js_string_addref_if_heap_string(double %r87)
  %r109 = bitcast double %r87 to i64
  call void @js_gc_note_slot_layout(i64 %r103, i32 2, i64 %r109)
  %r110 = or i64 %r103, 9222527611924643840
  %r111 = bitcast i64 %r110 to double
  %r112 = call double @js_child_process_validate_args(double %r111)
  %r113 = and i64 %r110, 281474976710655
  %r114 = load double, ptr %r31
  %r115 = call i64 @js_process_cwd()
  %r116 = or i64 %r115, 9223090561878065152
  %r117 = bitcast i64 %r116 to double
  %r118 = load double, ptr @cli_launcher_ts_.str.9.handle
  %r121 = load i64, ptr %r119
  %r122 = call i64 @js_object_alloc_class_inline_keys(i32 17, i32 0, i32 3, i64 %r121)
  %r123 = or i64 %r122, 9222527611924643840
  %r124 = bitcast i64 %r123 to double
  %r125 = call double @cli_launcher_ts____AnonShape_4402c0dde8651b90_constructor(double %r124, double %r114, double %r117, double %r118)
  call void @js_gc_init_typed_shape_layout(i64 %r122, i32 3, ptr null, i32 0, ptr @perry_typed_shape_mask_cli_launcher_ts____AnonShape_4402c0dde8651b90, i32 1)
  %r126 = call double @js_ctor_return_override(double %r124, double %r125, i32 0)
  %r127 = bitcast double %r126 to i64
  %r128 = and i64 %r127, 281474976710655
  %r129 = call double @js_child_process_spawn_streams(i64 %r84, i64 %r113, i64 %r128)
  store double %r129, ptr @perry_global_cli_launcher_ts__0
  %r130 = bitcast double %r129 to i64
  call void @js_write_barrier_root_nanbox(i64 %r130)
  %r131 = load double, ptr @cli_launcher_ts_.str.10.handle
  %r132 = load double, ptr @perry_global_cli_launcher_ts__0
  %r133 = bitcast double %r132 to i64
  %r134 = bitcast double 0x7FFC000000000002 to i64
  %r135 = icmp eq i64 %r133, %r134
  %r136 = icmp eq i64 %r133, 9222246136947933186
  %r137 = icmp eq i64 %r133, 9222246136947933185
  %r138 = icmp eq i64 %r134, 9222246136947933186
  %r139 = icmp eq i64 %r134, 9222246136947933185
  %r140 = or i1 %r136, %r137
  %r141 = or i1 %r138, %r139
  %r142 = and i1 %r140, %r141
  %r143 = or i1 %r135, %r142
  %r144 = select i1 %r143, i64 9222246136947933188, i64 9222246136947933187
  %r145 = bitcast i64 %r144 to double
  %r146 = icmp eq i64 %r144, 9222246136947933188
  br i1 %r146, label %ternary.then.13, label %ternary.else.14

ternary.then.13:
  br label %ternary.merge.15

ternary.else.14:
  %r147 = load double, ptr @perry_global_cli_launcher_ts__0
  %r148 = bitcast double %r147 to i64
  %r149 = and i64 %r148, 281474976710655
  %r150 = load double, ptr @cli_launcher_ts_.str.11.handle
  %r151 = bitcast double %r150 to i64
  %r152 = and i64 %r151, 281474976710655
  %r153 = lshr i64 %r148, 48
  %r154 = icmp eq i64 %r153, 32761
  %r155 = icmp eq i64 %r153, 32766
  %r156 = and i64 %r153, 65533
  %r157 = icmp eq i64 %r156, 32765
  br i1 %r154, label %pget.recv_sso.16, label %pget.check_class_ref.22

ternary.merge.15:
  %r202 = phi double [ 0x7FFC000000000001, %ternary.then.13 ], [ %r201, %pget.recv_merge.20 ]
  %r203 = load double, ptr @cli_launcher_ts_.str.12.handle
  %r205 = getelementptr double, ptr %r204, i64 0
  store double %r131, ptr %r205
  %r206 = getelementptr double, ptr %r204, i64 1
  store double %r202, ptr %r206
  %r207 = getelementptr double, ptr %r204, i64 2
  store double %r203, ptr %r207
  %r208 = ptrtoint ptr %r204 to i64
  %r209 = call i64 @js_string_concat_chain(i64 %r208, i32 3)
  %r210 = or i64 %r209, 9223090561878065152
  %r211 = bitcast i64 %r210 to double
  %r212 = call i64 @js_array_alloc(i32 1)
  %r213 = call i64 @js_array_push_f64(i64 %r212, double %r211)
  call void @js_console_log_spread(i64 %r213)
  call void @js_try_end()
  br label %try.finally.9

pget.recv_sso.16:
  %r200 = call double @js_object_get_field_by_name_f64(i64 %r148, i64 %r152)
  br label %pget.recv_merge.20

pget.recv_ok.17:
  call void @js_typed_feedback_observe_property_get(i64 6359313201921785856, i64 %r149, i64 %r152)
  %r159 = icmp ugt i64 %r149, 1048575
  %r160 = ptrtoint ptr @perry_ic_1 to i64
  %r161 = select i1 %r159, i64 %r149, i64 %r160
  %r162 = sub i64 %r161, 8
  %r163 = inttoptr i64 %r162 to ptr
  %r164 = load i8, ptr %r163
  %r165 = icmp eq i8 %r164, 2
  %r166 = and i1 %r159, %r165
  %r167 = add i64 %r161, 12
  %r168 = inttoptr i64 %r167 to ptr
  %r169 = load i32, ptr %r168
  %r170 = icmp eq i32 %r169, 1129268819
  %r171 = xor i1 %r170, true
  %r172 = and i1 %r166, %r171
  %r173 = inttoptr i64 %r161 to ptr
  %r174 = load i32, ptr %r173
  %r175 = icmp eq i32 %r174, 1
  %r176 = and i1 %r172, %r175
  %r177 = add i64 %r161, 16
  %r178 = inttoptr i64 %r177 to ptr
  %r179 = load i64, ptr %r178
  %r180 = getelementptr i64, ptr @perry_ic_1, i64 0
  %r181 = load i64, ptr %r180
  %r182 = icmp eq i64 %r179, %r181
  %r183 = icmp ne i64 %r179, 0
  %r184 = and i1 %r176, %r182
  %r185 = and i1 %r184, %r183
  br i1 %r185, label %pic.hit.23, label %pic.miss.24

pget.recv_bad.18:
  %r195 = icmp eq i64 %r148, 9222246136947933185
  %r196 = icmp eq i64 %r148, 9222246136947933186
  %r197 = or i1 %r195, %r196
  br i1 %r197, label %pget.throw_nullish.26, label %pget.recv_undef_return.27

pget.recv_class_ref.19:
  %r158 = call double @js_typed_feedback_object_get_field_by_name_f64(i64 6359313201921785856, i64 %r148, i64 %r152)
  br label %pget.recv_merge.20

pget.recv_merge.20:
  %r201 = phi double [ %r194, %pic.merge.25 ], [ %r199, %pget.recv_undef_return.27 ], [ %r200, %pget.recv_sso.16 ], [ %r158, %pget.recv_class_ref.19 ]
  br label %ternary.merge.15

pget.check_ptr.21:
  br i1 %r157, label %pget.recv_ok.17, label %pget.recv_bad.18

pget.check_class_ref.22:
  br i1 %r155, label %pget.recv_class_ref.19, label %pget.check_ptr.21

pic.hit.23:
  call void @js_typed_feedback_record_guard_pass(i64 6359313201921785856)
  %r186 = getelementptr i64, ptr @perry_ic_1, i64 1
  %r187 = load i64, ptr %r186
  %r188 = shl i64 %r187, 3
  %r189 = add i64 %r149, 24
  %r190 = add i64 %r189, %r188
  %r191 = inttoptr i64 %r190 to ptr
  %r192 = load double, ptr %r191
  br label %pic.merge.25

pic.miss.24:
  call void @js_typed_feedback_record_guard_fail(i64 6359313201921785856)
  call void @js_typed_feedback_record_fallback_call(i64 6359313201921785856)
  %r193 = call double @js_object_get_field_ic_miss(i64 %r149, i64 %r152, ptr @perry_ic_1)
  br label %pic.merge.25

pic.merge.25:
  %r194 = phi double [ %r192, %pic.hit.23 ], [ %r193, %pic.miss.24 ]
  br label %pget.recv_merge.20

pget.throw_nullish.26:
  %r198 = zext i1 %r196 to i32
  call void @js_throw_type_error_property_access(i32 %r198, ptr @cli_launcher_ts_.str.11.bytes, i64 3)
  unreachable

pget.recv_undef_return.27:
  %r199 = call double @js_object_get_field_by_name_f64(i64 %r148, i64 %r152)
  br label %pget.recv_merge.20

pget.recv_sso.28:
  %r270 = call double @js_object_get_field_by_name_f64(i64 %r218, i64 %r222)
  br label %pget.recv_merge.32

pget.recv_ok.29:
  call void @js_typed_feedback_observe_property_get(i64 6359313201921785858, i64 %r219, i64 %r222)
  %r229 = icmp ugt i64 %r219, 1048575
  %r230 = ptrtoint ptr @perry_ic_3 to i64
  %r231 = select i1 %r229, i64 %r219, i64 %r230
  %r232 = sub i64 %r231, 8
  %r233 = inttoptr i64 %r232 to ptr
  %r234 = load i8, ptr %r233
  %r235 = icmp eq i8 %r234, 2
  %r236 = and i1 %r229, %r235
  %r237 = add i64 %r231, 12
  %r238 = inttoptr i64 %r237 to ptr
  %r239 = load i32, ptr %r238
  %r240 = icmp eq i32 %r239, 1129268819
  %r241 = xor i1 %r240, true
  %r242 = and i1 %r236, %r241
  %r243 = inttoptr i64 %r231 to ptr
  %r244 = load i32, ptr %r243
  %r245 = icmp eq i32 %r244, 1
  %r246 = and i1 %r242, %r245
  %r247 = add i64 %r231, 16
  %r248 = inttoptr i64 %r247 to ptr
  %r249 = load i64, ptr %r248
  %r250 = getelementptr i64, ptr @perry_ic_3, i64 0
  %r251 = load i64, ptr %r250
  %r252 = icmp eq i64 %r249, %r251
  %r253 = icmp ne i64 %r249, 0
  %r254 = and i1 %r246, %r252
  %r255 = and i1 %r254, %r253
  br i1 %r255, label %pic.hit.35, label %pic.miss.36

pget.recv_bad.30:
  %r265 = icmp eq i64 %r218, 9222246136947933185
  %r266 = icmp eq i64 %r218, 9222246136947933186
  %r267 = or i1 %r265, %r266
  br i1 %r267, label %pget.throw_nullish.38, label %pget.recv_undef_return.39

pget.recv_class_ref.31:
  %r228 = call double @js_typed_feedback_object_get_field_by_name_f64(i64 6359313201921785858, i64 %r218, i64 %r222)
  br label %pget.recv_merge.32

pget.recv_merge.32:
  %r271 = phi double [ %r264, %pic.merge.37 ], [ %r269, %pget.recv_undef_return.39 ], [ %r270, %pget.recv_sso.28 ], [ %r228, %pget.recv_class_ref.31 ]
  %r272 = call double @js_dynamic_string_or_number_add(double %r216, double %r271)
  %r273 = call i64 @js_array_alloc(i32 1)
  %r274 = call i64 @js_array_push_f64(i64 %r273, double %r272)
  call void @js_console_log_spread(i64 %r274)
  br label %try.finally.9

pget.check_ptr.33:
  br i1 %r227, label %pget.recv_ok.29, label %pget.recv_bad.30

pget.check_class_ref.34:
  br i1 %r225, label %pget.recv_class_ref.31, label %pget.check_ptr.33

pic.hit.35:
  call void @js_typed_feedback_record_guard_pass(i64 6359313201921785858)
  %r256 = getelementptr i64, ptr @perry_ic_3, i64 1
  %r257 = load i64, ptr %r256
  %r258 = shl i64 %r257, 3
  %r259 = add i64 %r219, 24
  %r260 = add i64 %r259, %r258
  %r261 = inttoptr i64 %r260 to ptr
  %r262 = load double, ptr %r261
  br label %pic.merge.37

pic.miss.36:
  call void @js_typed_feedback_record_guard_fail(i64 6359313201921785858)
  call void @js_typed_feedback_record_fallback_call(i64 6359313201921785858)
  %r263 = call double @js_object_get_field_ic_miss(i64 %r219, i64 %r222, ptr @perry_ic_3)
  br label %pic.merge.37

pic.merge.37:
  %r264 = phi double [ %r262, %pic.hit.35 ], [ %r263, %pic.miss.36 ]
  br label %pget.recv_merge.32

pget.throw_nullish.38:
  %r268 = zext i1 %r266 to i32
  call void @js_throw_type_error_property_access(i32 %r268, ptr @cli_launcher_ts_.str.14.bytes, i64 7)
  unreachable

pget.recv_undef_return.39:
  %r269 = call double @js_object_get_field_by_name_f64(i64 %r218, i64 %r222)
  br label %pget.recv_merge.32
}

define double @perry_fn_cli_launcher_ts__stopCliService() alwaysinline {
entry.0:
  ret double 0x7FFC000000000001
}

define double @perry_fn_cli_launcher_ts__cliPath() alwaysinline {
entry.0:
  %r1 = call i64 @js_process_cwd()
  %r2 = or i64 %r1, 9223090561878065152
  %r3 = bitcast i64 %r2 to double
  %r4 = load double, ptr @cli_launcher_ts_.str.1.handle
  %r5 = and i64 %r2, 281474976710655
  %r6 = bitcast double %r4 to i64
  %r7 = and i64 %r6, 281474976710655
  %r8 = call i64 @js_path_join(i64 %r5, i64 %r7)
  %r9 = or i64 %r8, 9223090561878065152
  %r10 = bitcast i64 %r9 to double
  ret double %r10
}

define double @perry_closure_cli_launcher_ts__3(i64 %this_closure, double %arg3) {
entry.0:
  %r1 = alloca double
  store double %arg3, ptr %r1
  %r2 = load double, ptr %r1
  %r3 = call double @js_process_env()
  %r4 = call double @js_object_assign_one(double %r2, double %r3)
  %r5 = load double, ptr %r1
  %r6 = load double, ptr @cli_launcher_ts_.str.17.handle
  %r7 = bitcast double %r6 to i64
  %r8 = bitcast double %r5 to i64
  %r9 = icmp eq i64 %r8, 9222246136947933185
  %r10 = icmp eq i64 %r8, 9222246136947933186
  %r11 = or i1 %r9, %r10
  br i1 %r11, label %iset.literal.throw_nullish.1, label %iset.literal.recv_ok.2

iset.literal.throw_nullish.1:
  %r12 = zext i1 %r10 to i32
  call void @js_throw_type_error_property_access(i32 %r12, ptr @cli_launcher_ts_.str.18.bytes, i64 8)
  unreachable

iset.literal.recv_ok.2:
  %r13 = lshr i64 %r8, 48
  %r14 = and i64 %r13, 65533
  %r15 = icmp eq i64 %r14, 32765
  %r16 = and i64 %r8, 281474976710655
  %r17 = select i1 %r15, i64 %r16, i64 %r8
  %r18 = load double, ptr @cli_launcher_ts_.str.18.handle
  %r19 = bitcast double %r18 to i64
  %r20 = and i64 %r19, 281474976710655
  call void @js_typed_feedback_object_set_field_by_name(i64 6359313201921785860, i64 %r17, i64 %r20, double %r6)
  %r21 = load double, ptr %r1
  %r22 = load double, ptr @cli_launcher_ts_.str.19.handle
  %r23 = bitcast double %r22 to i64
  %r24 = bitcast double %r21 to i64
  %r25 = icmp eq i64 %r24, 9222246136947933185
  %r26 = icmp eq i64 %r24, 9222246136947933186
  %r27 = or i1 %r25, %r26
  br i1 %r27, label %iset.literal.throw_nullish.3, label %iset.literal.recv_ok.4

iset.literal.throw_nullish.3:
  %r28 = zext i1 %r26 to i32
  call void @js_throw_type_error_property_access(i32 %r28, ptr @cli_launcher_ts_.str.20.bytes, i64 9)
  unreachable

iset.literal.recv_ok.4:
  %r29 = lshr i64 %r24, 48
  %r30 = and i64 %r29, 65533
  %r31 = icmp eq i64 %r30, 32765
  %r32 = and i64 %r24, 281474976710655
  %r33 = select i1 %r31, i64 %r32, i64 %r24
  %r34 = load double, ptr @cli_launcher_ts_.str.20.handle
  %r35 = bitcast double %r34 to i64
  %r36 = and i64 %r35, 281474976710655
  call void @js_typed_feedback_object_set_field_by_name(i64 6359313201921785861, i64 %r33, i64 %r36, double %r22)
  %r37 = load double, ptr %r1
  ret double %r37
}

define double @cli_launcher_ts____AnonShape_4402c0dde8651b90_constructor(double %this_arg, double %arg6, double %arg7, double %arg8) {
entry.0:
  %r1 = alloca double
  store double %this_arg, ptr %r1
  %r2 = alloca double
  store double %arg6, ptr %r2
  %r3 = alloca double
  store double %arg7, ptr %r3
  %r4 = alloca double
  store double %arg8, ptr %r4
  %r5 = load double, ptr %r1
  %r6 = bitcast double %r5 to i64
  %r7 = and i64 %r6, 281474976710655
  %r8 = load double, ptr @cli_launcher_ts_.str.21.handle
  %r9 = bitcast double %r8 to i64
  %r10 = and i64 %r9, 281474976710655
  %r11 = load i64, ptr @perry_class_keys_cli_launcher_ts____AnonShape_4402c0dde8651b90
  %r12 = bitcast double 0x7FFC000000000001 to i64
  %r13 = call i32 @js_typed_feedback_class_field_set_guard(i64 6359313201921785862, double %r5, i32 17, i64 %r11, i64 %r10, i32 0, double 0x7FFC000000000001, i32 0)
  %r14 = icmp ne i32 %r13, 0
  br i1 %r14, label %class_field_set.fast.1, label %class_field_set.fallback.2

class_field_set.fast.1:
  %r15 = inttoptr i64 %r7 to ptr
  %r16 = getelementptr i8, ptr %r15, i64 24
  %r17 = getelementptr double, ptr %r16, i64 0
  ...
  call void @js_gc_note_slot_layout(i64 %r7, i32 0, i64 %r19)
  br label %class_field_set.merge.3

class_field_set.fallback.2:
  call void @js_class_field_set_fallback(i64 6359313201921785862, i64 %r6, i64 %r10, double 0x7FFC000000000001)
  br label %class_field_set.merge.3

class_field_set.merge.3:
  %r20 = load double, ptr %r1
  %r21 = bitcast double %r20 to i64
  %r22 = and i64 %r21, 281474976710655
  %r23 = load double, ptr @cli_launcher_ts_.str.22.handle
  %r24 = bitcast double %r23 to i64
  %r25 = and i64 %r24, 281474976710655
  %r26 = load i64, ptr @perry_class_keys_cli_launcher_ts____AnonShape_4402c0dde8651b90
  %r27 = bitcast double 0x7FFC000000000001 to i64
  %r28 = call i32 @js_typed_feedback_class_field_set_guard(i64 6359313201921785863, double %r20, i32 17, i64 %r26, i64 %r25, i32 1, double 0x7FFC000000000001, i32 0)
  %r29 = icmp ne i32 %r28, 0
  br i1 %r29, label %class_field_set.fast.4, label %class_field_set.fallback.5

class_field_set.fast.4:
  %r30 = inttoptr i64 %r22 to ptr
  %r31 = getelementptr i8, ptr %r30, i64 24
  %r32 = getelementptr double, ptr %r31, i64 1
  %r33 = ptrtoint ptr %r32 to i64
  store double 0x7FFC000000000001, ptr %r32
  call void @js_string_addref_if_heap_string(double 0x7FFC000000000001)
  %r34 = bitcast double 0x7FFC000000000001 to i64
  call void @js_gc_note_slot_layout(i64 %r22, i32 1, i64 %r34)
  br label %class_field_set.merge.6

class_field_set.fallback.5:
  call void @js_class_field_set_fallback(i64 6359313201921785863, i64 %r21, i64 %r25, double 0x7FFC000000000001)
  br label %class_field_set.merge.6

class_field_set.merge.6:
  %r35 = load double, ptr %r1
  %r36 = bitcast double %r35 to i64
  %r37 = and i64 %r36, 281474976710655
  %r38 = load double, ptr @cli_launcher_ts_.str.23.handle
  %r39 = bitcast double %r38 to i64
  %r40 = and i64 %r39, 281474976710655
  %r41 = load i64, ptr @perry_class_keys_cli_launcher_ts____AnonShape_4402c0dde8651b90
  %r42 = bitcast double 0x7FFC000000000001 to i64
  %r43 = call i32 @js_typed_feedback_class_field_set_guard(i64 6359313201921785864, double %r35, i32 17, i64 %r41, i64 %r40, i32 2, double 0x7FFC000000000001, i32 0)
...
class_field_set.fast.7:
  ...
  %r47 = getelementptr double, ptr %r46, i64 2
  %r48 = ptrtoint ptr %r47 to i64
  store double 0x7FFC000000000001, ptr %r47
  call void @js_string_addref_if_heap_string(double 0x7FFC000000000001)
  %r49 = bitcast double 0x7FFC000000000001 to i64
  call void @js_gc_note_slot_layout(i64 %r37, i32 2, i64 %r49)
  br label %class_field_set.merge.9

class_field_set.fallback.8:
  call void @js_class_field_set_fallback(i64 6359313201921785864, i64 %r36, i64 %r40, double 0x7FFC000000000001)
  br label %class_field_set.merge.9

class_field_set.merge.9:
  %r50 = load double, ptr %r1
  %r51 = load double, ptr %r2
  %r52 = bitcast double %r50 to i64
  %r53 = and i64 %r52, 281474976710655
  %r54 = load double, ptr @cli_launcher_ts_.str.21.handle
  %r55 = bitcast double %r54 to i64
  %r56 = and i64 %r55, 281474976710655
  %r57 = load i64, ptr @perry_class_keys_cli_launcher_ts____AnonShape_4402c0dde8651b90
  %r58 = bitcast double %r51 to i64
  %r59 = call i32 @js_typed_feedback_class_field_set_guard(i64 6359313201921785865, double %r50, i32 17, i64 %r57, i64 %r56, i32 0, double %r51, i32 0)
...
class_field_set.fast.10:
  ...
  call void @js_gc_note_slot_layout(i64 %r53, i32 0, i64 %r65)
  call void @js_write_barrier_slot(i64 %r52, i64 %r64, i64 %r65)
  br label %class_field_set.merge.12

class_field_set.fallback.11:
  call void @js_class_field_set_fallback(i64 6359313201921785865, i64 %r52, i64 %r56, double %r51)
  br label %class_field_set.merge.12

class_field_set.merge.12:
  %r66 = load double, ptr %r1
  %r67 = load double, ptr %r3
  %r68 = bitcast double %r66 to i64
  %r69 = and i64 %r68, 281474976710655
  %r70 = load double, ptr @cli_launcher_ts_.str.22.handle
  %r71 = bitcast double %r70 to i64
  %r72 = and i64 %r71, 281474976710655
  %r73 = load i64, ptr @perry_class_keys_cli_launcher_ts____AnonShape_4402c0dde8651b90
  %r74 = bitcast double %r67 to i64
  %r75 = call i32 @js_typed_feedback_class_field_set_guard(i64 6359313201921785866, double %r66, i32 17, i64 %r73, i64 %r72, i32 1, double %r67, i32 0)
...
class_field_set.fast.13:
  ...
  %r79 = getelementptr double, ptr %r78, i64 1
  %r80 = ptrtoint ptr %r79 to i64
  store double %r67, ptr %r79
  call void @js_string_addref_if_heap_string(double %r67)
  %r81 = bitcast double %r67 to i64
  call void @js_gc_note_slot_layout(i64 %r69, i32 1, i64 %r81)
  call void @js_write_barrier_slot(i64 %r68, i64 %r80, i64 %r81)
  br label %class_field_set.merge.15

class_field_set.fallback.14:
  call void @js_class_field_set_fallback(i64 6359313201921785866, i64 %r68, i64 %r72, double %r67)
  br label %class_field_set.merge.15

class_field_set.merge.15:
  %r82 = load double, ptr %r1
  %r83 = load double, ptr %r4
  %r84 = bitcast double %r82 to i64
  %r85 = and i64 %r84, 281474976710655
  %r86 = load double, ptr @cli_launcher_ts_.str.23.handle
  %r87 = bitcast double %r86 to i64
  %r88 = and i64 %r87, 281474976710655
  %r89 = load i64, ptr @perry_class_keys_cli_launcher_ts____AnonShape_4402c0dde8651b90
  %r90 = bitcast double %r83 to i64
  %r91 = call i32 @js_typed_feedback_class_field_set_guard(i64 6359313201921785867, double %r82, i32 17, i64 %r89, i64 %r88, i32 2, double %r83, i32 0)
...
class_field_set.fast.16:
  ...
  %r95 = getelementptr double, ptr %r94, i64 2
  ...
  call void @js_gc_note_slot_layout(i64 %r85, i32 2, i64 %r97)
  call void @js_write_barrier_slot(i64 %r84, i64 %r96, i64 %r97)
  br label %class_field_set.merge.18

class_field_set.fallback.17:
  call void @js_class_field_set_fallback(i64 6359313201921785867, i64 %r84, i64 %r88, double %r83)
  br label %class_field_set.merge.18
...
define double @__perry_wrap_perry_fn_cli_launcher_ts__startCliService(i64 %this_closure) {
entry.0:
  %r1 = call double @perry_fn_cli_launcher_ts__startCliService()
  ret double %r1
}

define double @__perry_wrap_perry_fn_cli_launcher_ts__stopCliService(i64 %this_closure) {
entry.0:
  %r1 = call double @perry_fn_cli_launcher_ts__stopCliService()
  ret double %r1
}

define double @__perry_wrap_perry_fn_cli_launcher_ts__cliPath(i64 %this_closure) {
entry.0:
  %r1 = call double @perry_fn_cli_launcher_ts__cliPath()
  ret double %r1
}
...
define internal double @__perry_wrap_extern_api_ts__setApiPort(i64 %this_closure, double %a0) {
entry.0:
  %r1 = call double @perry_fn_api_ts__setApiPort(double %a0)
  ret double %r1
}

define void @cli_launcher_ts__init() {
entry.0:
  %r1 = load i8, ptr @__perry_init_done_cli_launcher_ts
  %r2 = icmp ne i8 %r1, 0
...
guard.do.2:
  store i8 1, ptr @__perry_init_done_cli_launcher_ts
  call void @api_ts__init()
  call void @cli_launcher_ts__init_body()
  ret void
}

define external void @cli_launcher_ts__init_body() {
entry.0:
  call void @js_gc_write_barriers_emitted(i32 1)
  call void @__perry_init_strings_cli_launcher_ts()
  %r1 = ptrtoint ptr @perry_global_cli_launcher_ts__0 to i64
  call void @js_gc_register_global_root(i64 %r1)
  store double 0x7FFC000000000002, ptr @perry_global_cli_launcher_ts__0
  %r2 = bitcast double 0x7FFC000000000002 to i64
  call void @js_write_barrier_root_nanbox(i64 %r2)
  ret void
}

define void @__perry_init_strings_cli_launcher_ts_chunk0() {
entry.0:
  %r1 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.0.bytes, i32 31)
  %r2 = call double @js_nanbox_string(i64 %r1)
  store double %r2, ptr @cli_launcher_ts_.str.0.handle
  %r3 = ptrtoint ptr @cli_launcher_ts_.str.0.handle to i64
  call void @js_gc_register_global_root(i64 %r3)
  %r4 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.1.bytes, i32 12)
  %r5 = call double @js_nanbox_string(i64 %r4)
  store double %r5, ptr @cli_launcher_ts_.str.1.handle
  %r6 = ptrtoint ptr @cli_launcher_ts_.str.1.handle to i64
  call void @js_gc_register_global_root(i64 %r6)
  %r7 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.2.bytes, i32 13)
  %r8 = call double @js_nanbox_string(i64 %r7)
  store double %r8, ptr @cli_launcher_ts_.str.2.handle
  %r9 = ptrtoint ptr @cli_launcher_ts_.str.2.handle to i64
  call void @js_gc_register_global_root(i64 %r9)
  %r10 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.3.bytes, i32 12)
  %r11 = call double @js_nanbox_string(i64 %r10)
  store double %r11, ptr @cli_launcher_ts_.str.3.handle
  %r12 = ptrtoint ptr @cli_launcher_ts_.str.3.handle to i64
  call void @js_gc_register_global_root(i64 %r12)
  %r13 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.4.bytes, i32 4)
  %r14 = call double @js_nanbox_string(i64 %r13)
  store double %r14, ptr @cli_launcher_ts_.str.4.handle
  %r15 = ptrtoint ptr @cli_launcher_ts_.str.4.handle to i64
  call void @js_gc_register_global_root(i64 %r15)
  %r16 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.5.bytes, i32 7)
  %r17 = call double @js_nanbox_string(i64 %r16)
  store double %r17, ptr @cli_launcher_ts_.str.5.handle
  %r18 = ptrtoint ptr @cli_launcher_ts_.str.5.handle to i64
  call void @js_gc_register_global_root(i64 %r18)
  %r19 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.6.bytes, i32 44)
  %r20 = call double @js_nanbox_string(i64 %r19)
  store double %r20, ptr @cli_launcher_ts_.str.6.handle
  %r21 = ptrtoint ptr @cli_launcher_ts_.str.6.handle to i64
  call void @js_gc_register_global_root(i64 %r21)
  %r22 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.7.bytes, i32 7)
  %r23 = call double @js_nanbox_string(i64 %r22)
  store double %r23, ptr @cli_launcher_ts_.str.7.handle
  %r24 = ptrtoint ptr @cli_launcher_ts_.str.7.handle to i64
  call void @js_gc_register_global_root(i64 %r24)
  %r25 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.8.bytes, i32 2)
  %r26 = call double @js_nanbox_string(i64 %r25)
  store double %r26, ptr @cli_launcher_ts_.str.8.handle
  %r27 = ptrtoint ptr @cli_launcher_ts_.str.8.handle to i64
  call void @js_gc_register_global_root(i64 %r27)
  %r28 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.9.bytes, i32 4)
  %r29 = call double @js_nanbox_string(i64 %r28)
  store double %r29, ptr @cli_launcher_ts_.str.9.handle
  %r30 = ptrtoint ptr @cli_launcher_ts_.str.9.handle to i64
  call void @js_gc_register_global_root(i64 %r30)
  %r31 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.10.bytes, i32 40)
  %r32 = call double @js_nanbox_string(i64 %r31)
  store double %r32, ptr @cli_launcher_ts_.str.10.handle
  %r33 = ptrtoint ptr @cli_launcher_ts_.str.10.handle to i64
  call void @js_gc_register_global_root(i64 %r33)
  %r34 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.11.bytes, i32 3)
  %r35 = call double @js_nanbox_string(i64 %r34)
  store double %r35, ptr @cli_launcher_ts_.str.11.handle
  %r36 = ptrtoint ptr @cli_launcher_ts_.str.11.handle to i64
  call void @js_gc_register_global_root(i64 %r36)
  %r37 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.12.bytes, i32 1)
  %r38 = call double @js_nanbox_string(i64 %r37)
  store double %r38, ptr @cli_launcher_ts_.str.12.handle
  %r39 = ptrtoint ptr @cli_launcher_ts_.str.12.handle to i64
  call void @js_gc_register_global_root(i64 %r39)
  %r40 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.13.bytes, i32 31)
  %r41 = call double @js_nanbox_string(i64 %r40)
  store double %r41, ptr @cli_launcher_ts_.str.13.handle
  %r42 = ptrtoint ptr @cli_launcher_ts_.str.13.handle to i64
  call void @js_gc_register_global_root(i64 %r42)
  %r43 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.14.bytes, i32 7)
  %r44 = call double @js_nanbox_string(i64 %r43)
  store double %r44, ptr @cli_launcher_ts_.str.14.handle
  %r45 = ptrtoint ptr @cli_launcher_ts_.str.14.handle to i64
  call void @js_gc_register_global_root(i64 %r45)
  %r46 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.15.bytes, i32 50)
  %r47 = call double @js_nanbox_string(i64 %r46)
  store double %r47, ptr @cli_launcher_ts_.str.15.handle
  %r48 = ptrtoint ptr @cli_launcher_ts_.str.15.handle to i64
  call void @js_gc_register_global_root(i64 %r48)
  %r49 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.16.bytes, i32 71)
  %r50 = call double @js_nanbox_string(i64 %r49)
  store double %r50, ptr @cli_launcher_ts_.str.16.handle
  %r51 = ptrtoint ptr @cli_launcher_ts_.str.16.handle to i64
  call void @js_gc_register_global_root(i64 %r51)
  %r52 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.17.bytes, i32 4)
  %r53 = call double @js_nanbox_string(i64 %r52)
  store double %r53, ptr @cli_launcher_ts_.str.17.handle
  %r54 = ptrtoint ptr @cli_launcher_ts_.str.17.handle to i64
  call void @js_gc_register_global_root(i64 %r54)
  %r55 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.18.bytes, i32 8)
  %r56 = call double @js_nanbox_string(i64 %r55)
  store double %r56, ptr @cli_launcher_ts_.str.18.handle
  %r57 = ptrtoint ptr @cli_launcher_ts_.str.18.handle to i64
  call void @js_gc_register_global_root(i64 %r57)
  %r58 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.19.bytes, i32 4)
  %r59 = call double @js_nanbox_string(i64 %r58)
  store double %r59, ptr @cli_launcher_ts_.str.19.handle
  %r60 = ptrtoint ptr @cli_launcher_ts_.str.19.handle to i64
  call void @js_gc_register_global_root(i64 %r60)
  %r61 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.20.bytes, i32 9)
  %r62 = call double @js_nanbox_string(i64 %r61)
  store double %r62, ptr @cli_launcher_ts_.str.20.handle
  %r63 = ptrtoint ptr @cli_launcher_ts_.str.20.handle to i64
  call void @js_gc_register_global_root(i64 %r63)
  %r64 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.21.bytes, i32 3)
  %r65 = call double @js_nanbox_string(i64 %r64)
  store double %r65, ptr @cli_launcher_ts_.str.21.handle
  %r66 = ptrtoint ptr @cli_launcher_ts_.str.21.handle to i64
  call void @js_gc_register_global_root(i64 %r66)
  %r67 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.22.bytes, i32 3)
  %r68 = call double @js_nanbox_string(i64 %r67)
  store double %r68, ptr @cli_launcher_ts_.str.22.handle
  %r69 = ptrtoint ptr @cli_launcher_ts_.str.22.handle to i64
  call void @js_gc_register_global_root(i64 %r69)
  %r70 = call i64 @js_string_from_bytes(ptr @cli_launcher_ts_.str.23.bytes, i32 5)
  %r71 = call double @js_nanbox_string(i64 %r70)
  store double %r71, ptr @cli_launcher_ts_.str.23.handle
  %r72 = ptrtoint ptr @cli_launcher_ts_.str.23.handle to i64
  call void @js_gc_register_global_root(i64 %r72)
  call void @js_register_function_name(ptr @__perry_wrap_perry_fn_cli_launcher_ts__startCliService, ptr @.str.0, i32 15)
  call void @js_register_function_name(ptr @__perry_wrap_perry_fn_cli_launcher_ts__stopCliService, ptr @.str.1, i32 14)
  call void @js_register_function_name(ptr @__perry_wrap_perry_fn_cli_launcher_ts__cliPath, ptr @.str.2, i32 7)
  call void @js_register_function_source(ptr @__perry_wrap_perry_fn_cli_launcher_ts__startCliService, ptr @.str.3, i32 1110)
  call void @js_register_function_source(ptr @__perry_wrap_perry_fn_cli_launcher_ts__stopCliService, ptr @.str.4, i32 75)
  call void @js_register_function_source(ptr @__perry_wrap_perry_fn_cli_launcher_ts__cliPath, ptr @.str.5, i32 76)
  %r73 = call i64 @js_build_class_keys_array(i32 17, i32 3, ptr @perry_class_keys_packed_cli_launcher_ts__0, i32 14)
  store i64 %r73, ptr @perry_class_keys_cli_launcher_ts____AnonShape_4402c0dde8651b90
  call void @js_write_barrier_root_heap_word(i64 %r73)
  %r74 = ptrtoint ptr @perry_class_keys_cli_launcher_ts____AnonShape_4402c0dde8651b90 to i64
  call void @js_gc_register_global_root(i64 %r74)
  %r75 = ptrtoint ptr @cli_launcher_ts____AnonShape_4402c0dde8651b90_constructor to i64
  call void @js_register_class_constructor(i64 17, i64 %r75, i64 3)
  call void @js_register_class_id(i32 17)
  call void @js_register_anon_shape_class_id(i32 17)
  call void @js_register_closure_arity(ptr @perry_closure_cli_launcher_ts__3, i32 1)
  call void @js_register_closure_length(ptr @perry_closure_cli_launcher_ts__3, i32 1)
  call void @js_register_closure_arity(ptr @__perry_wrap_perry_fn_cli_launcher_ts__cliPath, i32 0)
  call void @js_register_closure_arity(ptr @__perry_wrap_perry_fn_cli_launcher_ts__startCliService, i32 0)
  call void @js_register_closure_arity(ptr @__perry_wrap_perry_fn_cli_launcher_ts__stopCliService, i32 0)
  call void @js_register_closure_length(ptr @__perry_wrap_perry_fn_cli_launcher_ts__cliPath, i32 0)
  call void @js_register_closure_length(ptr @__perry_wrap_perry_fn_cli_launcher_ts__startCliService, i32 0)
  call void @js_register_closure_length(ptr @__perry_wrap_perry_fn_cli_launcher_ts__stopCliService, i32 0)
  call void @js_register_closure_strict_function(ptr @__perry_wrap_perry_fn_cli_launcher_ts__cliPath)
  call void @js_register_closure_strict_function(ptr @__perry_wrap_perry_fn_cli_launcher_ts__startCliService)
  call void @js_register_closure_strict_function(ptr @__perry_wrap_perry_fn_cli_launcher_ts__stopCliService)
  call void @js_register_closure_strict_function(ptr @perry_closure_cli_launcher_ts__3)
  ret void
}

define void @__perry_init_strings_cli_launcher_ts() {
entry.0:
  call void @__perry_init_strings_cli_launcher_ts_chunk0()
  ret void
}
