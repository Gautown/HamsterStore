...
@tray_ts_.str.0.bytes = private unnamed_addr constant [16 x i8] c"\E6\98\BE\E7\A4\BA\E4\B8\BB\E7\AA\97\E5\8F\A3\00"
@tray_ts_.str.1.bytes = private unnamed_addr constant [7 x i8] c"\E9\80\80\E5\87\BA\00"
@tray_ts_.str.2.bytes = private unnamed_addr constant [29 x i8] c"[tray] \E7\B3\BB\E7\BB\9F\E6\89\98\E7\9B\98\E5\B7\B2\E5\90\AF\E5\8A\A8\00"
@tray_ts_.str.3.bytes = private unnamed_addr constant [23 x i8] c"[tray] \E6\98\BE\E7\A4\BA\E4\B8\BB\E7\AA\97\E5\8F\A3\00"
@tray_ts_.str.4.bytes = private unnamed_addr constant [20 x i8] c"[tray] \E9\80\80\E5\87\BA\E7\A8\8B\E5\BA\8F\00"
@tray_ts_.str.5.bytes = private unnamed_addr constant [47 x i8] c"[tray] \E6\89\98\E7\9B\98\E5\8F\8C\E5\87\BB / \E7\82\B9\E5\87\BB\EF\BC\8C\E6\98\BE\E7\A4\BA\E4\B8\BB\E7\AA\97\E5\8F\A3\00"
@tray_ts_.str.6.bytes = private unnamed_addr constant [7 x i8] c"assets\00"
@tray_ts_.str.7.bytes = private unnamed_addr constant [9 x i8] c"icon.ico\00"
@tray_ts_.str.8.bytes = private unnamed_addr constant [9 x i8] c"icon.png\00"
@tray_ts_.str.9.bytes = private unnamed_addr constant [1 x i8] c"\00"
@.str.0 = private unnamed_addr constant [9 x i8] c"initTray\00"
@.str.1 = private unnamed_addr constant [595 x i8] c"function initTray() {\0A  // trayCreate BEFORE App() \E2\80\94 produces harmless warning, tray still works\0A  const tray = trayCreate(trayIcon);\0A\0A  const trayMenu = menuCreate();\0A  menuAddItem(trayMenu, \22\E6\98\BE\E7\A4\BA\E4\B8\BB\E7\AA\97\E5\8F\A3\22, () => {\0A    console.log(\22[tray] \E6\98\BE\E7\A4\BA\E4\B8\BB\E7\AA\97\E5\8F\A3\22);\0A  });\0A  menuAddSeparator(trayMenu);\0A  menuAddItem(trayMenu, \22\E9\80\80\E5\87\BA\22, () => {\0A    console.log(\22[tray] \E9\80\80\E5\87\BA\E7\A8\8B\E5\BA\8F\22);\0A    process.exit(0);\0A  });\0A  trayAttachMenu(tray, trayMenu);\0A\0A  trayOnClick(tray, () => {\0A    console.log(\22[tray] \E6\89\98\E7\9B\98\E5\8F\8C\E5\87\BB / \E7\82\B9\E5\87\BB\EF\BC\8C\E6\98\BE\E7\A4\BA\E4\B8\BB\E7\AA\97\E5\8F\A3\22);\0A  });\0A\0A  console.log(\22[tray] \E7\B3\BB\E7\BB\9F\E6\89\98\E7\9B\98\E5\B7\B2\E5\90\AF\E5\8A\A8\22);\0A}\00"
@.str.2 = private unnamed_addr constant [73 x i8] c"() => {\0A    console.log(\22[tray] \E9\80\80\E5\87\BA\E7\A8\8B\E5\BA\8F\22);\0A    process.exit(0);\0A  }\00"
@.str.3 = private unnamed_addr constant [79 x i8] c"() => {\0A    console.log(\22[tray] \E6\89\98\E7\9B\98\E5\8F\8C\E5\87\BB / \E7\82\B9\E5\87\BB\EF\BC\8C\E6\98\BE\E7\A4\BA\E4\B8\BB\E7\AA\97\E5\8F\A3\22);\0A  }\00"
@.str.4 = private unnamed_addr constant [55 x i8] c"() => {\0A    console.log(\22[tray] \E6\98\BE\E7\A4\BA\E4\B8\BB\E7\AA\97\E5\8F\A3\22);\0A  }\00"
...
@perry_global_tray_ts__3 = global double 0x7FFC000000000001
@__perry_init_done_tray_ts = internal global i8 0
@tray_ts_.str.0.handle = internal global double 0.0
@tray_ts_.str.1.handle = internal global double 0.0
@tray_ts_.str.2.handle = internal global double 0.0
@tray_ts_.str.3.handle = internal global double 0.0
@tray_ts_.str.4.handle = internal global double 0.0
@tray_ts_.str.5.handle = internal global double 0.0
@tray_ts_.str.6.handle = internal global double 0.0
@tray_ts_.str.7.handle = internal global double 0.0
@tray_ts_.str.8.handle = internal global double 0.0
@tray_ts_.str.9.handle = internal global double 0.0
...
declare i64 @perry_ui_tray_create(i64)
declare i64 @perry_ui_menu_create()
declare void @perry_ui_menu_add_item(i64, i64, double)
declare void @perry_ui_menu_add_separator(i64)
declare void @perry_ui_tray_attach_menu(i64, i64)
declare void @perry_ui_tray_on_click(i64, double)

define double @perry_fn_tray_ts__initTray() alwaysinline {
entry.0:
  %r1 = alloca i64
  ...
  %r4 = load double, ptr @perry_global_tray_ts__3
  %r5 = call i64 @js_get_string_pointer_unified(double %r4)
  %r6 = call i64 @perry_ui_tray_create(i64 %r5)
  %r7 = or i64 %r6, 9222527611924643840
  %r8 = bitcast i64 %r7 to double
  store double %r8, ptr %r3
  call void @js_shadow_slot_bind(i32 0, ptr %r3)
  call void @js_shadow_slot_set(i32 0, i64 %r7)
  %r10 = call i64 @perry_ui_menu_create()
  %r11 = or i64 %r10, 9222527611924643840
  %r12 = bitcast i64 %r11 to double
  store double %r12, ptr %r9
  call void @js_shadow_slot_bind(i32 1, ptr %r9)
  call void @js_shadow_slot_set(i32 1, i64 %r11)
  %r13 = load double, ptr %r9
  %r14 = bitcast double %r13 to i64
  %r15 = and i64 %r14, 281474976710655
  %r16 = load double, ptr @tray_ts_.str.0.handle
  %r17 = call i64 @js_get_string_pointer_unified(double %r16)
  %r18 = call i64 @js_closure_alloc_singleton(ptr @perry_closure_tray_ts__1)
  %r19 = or i64 %r18, 9222527611924643840
  %r20 = bitcast i64 %r19 to double
  call void @perry_ui_menu_add_item(i64 %r15, i64 %r17, double %r20)
  %r21 = load double, ptr %r9
  %r22 = bitcast double %r21 to i64
  %r23 = and i64 %r22, 281474976710655
  call void @perry_ui_menu_add_separator(i64 %r23)
  %r24 = load double, ptr %r9
  %r25 = bitcast double %r24 to i64
  %r26 = and i64 %r25, 281474976710655
  %r27 = load double, ptr @tray_ts_.str.1.handle
  %r28 = call i64 @js_get_string_pointer_unified(double %r27)
  %r29 = call i64 @js_closure_alloc_singleton(ptr @perry_closure_tray_ts__2)
  %r30 = or i64 %r29, 9222527611924643840
  %r31 = bitcast i64 %r30 to double
  call void @perry_ui_menu_add_item(i64 %r26, i64 %r28, double %r31)
  %r32 = load double, ptr %r3
  %r33 = bitcast double %r32 to i64
  %r34 = and i64 %r33, 281474976710655
  %r35 = load double, ptr %r9
  %r36 = bitcast double %r35 to i64
  %r37 = and i64 %r36, 281474976710655
  call void @perry_ui_tray_attach_menu(i64 %r34, i64 %r37)
  call void @js_shadow_slot_set(i32 1, i64 0)
  %r38 = load double, ptr %r3
  %r39 = bitcast double %r38 to i64
  %r40 = and i64 %r39, 281474976710655
  %r41 = call i64 @js_closure_alloc_singleton(ptr @perry_closure_tray_ts__3)
  %r42 = or i64 %r41, 9222527611924643840
  %r43 = bitcast i64 %r42 to double
  call void @perry_ui_tray_on_click(i64 %r40, double %r43)
  call void @js_shadow_slot_set(i32 0, i64 0)
  %r44 = load double, ptr @tray_ts_.str.2.handle
  %r45 = call i64 @js_array_alloc(i32 1)
  %r46 = call i64 @js_array_push_f64(i64 %r45, double %r44)
  call void @js_console_log_spread(i64 %r46)
  %shadow_pop_l_0 = load i64, ptr %r1
  call void @js_shadow_frame_pop(i64 %shadow_pop_l_0)
  ret double 0x7FFC000000000001
}

define double @perry_closure_tray_ts__1(i64 %this_closure) {
entry.0:
  %r1 = load double, ptr @tray_ts_.str.3.handle
...
define double @perry_closure_tray_ts__2(i64 %this_closure) {
entry.0:
  %r1 = load double, ptr @tray_ts_.str.4.handle
  %r2 = call i64 @js_array_alloc(i32 1)
  %r3 = call i64 @js_array_push_f64(i64 %r2, double %r1)
  call void @js_console_log_spread(i64 %r3)
  call void @js_process_exit(double 0.0)
  ret double 0x7FFC000000000001
}

define double @perry_closure_tray_ts__3(i64 %this_closure) {
entry.0:
  %r1 = load double, ptr @tray_ts_.str.5.handle
  %r2 = call i64 @js_array_alloc(i32 1)
  %r3 = call i64 @js_array_push_f64(i64 %r2, double %r1)
  call void @js_console_log_spread(i64 %r3)
  ret double 0x7FFC000000000001
...
define double @__perry_wrap_perry_fn_tray_ts__initTray(i64 %this_closure) {
entry.0:
...
define void @tray_ts__init() {
entry.0:
  %r1 = load i8, ptr @__perry_init_done_tray_ts
  %r2 = icmp ne i8 %r1, 0
...
guard.do.2:
  store i8 1, ptr @__perry_init_done_tray_ts
  call void @tray_ts__init_body()
  ret void
}

define external void @tray_ts__init_body() {
entry.0:
  %r1 = alloca i64
  %r4 = alloca double
  store double 0x7FFC000000000001, ptr %r4
  %r22 = alloca double
  store double 0x7FFC000000000001, ptr %r22
  %r40 = alloca double
  store double 0x7FFC000000000001, ptr %r40
  call void @js_gc_write_barriers_emitted(i32 1)
  call void @__perry_init_strings_tray_ts()
  %r2 = call i64 @js_shadow_frame_push(i32 4)
  store i64 %r2, ptr %r1
  %r3 = ptrtoint ptr @perry_global_tray_ts__3 to i64
  call void @js_gc_register_global_root(i64 %r3)
  %r5 = call i64 @js_process_cwd()
  %r6 = or i64 %r5, 9223090561878065152
  %r7 = bitcast i64 %r6 to double
  %r8 = load double, ptr @tray_ts_.str.6.handle
  %r9 = and i64 %r6, 281474976710655
  %r10 = bitcast double %r8 to i64
  %r11 = and i64 %r10, 281474976710655
  %r12 = call i64 @js_path_join(i64 %r9, i64 %r11)
  %r13 = or i64 %r12, 9223090561878065152
  %r14 = bitcast i64 %r13 to double
  %r15 = load double, ptr @tray_ts_.str.7.handle
  %r16 = and i64 %r13, 281474976710655
  %r17 = bitcast double %r15 to i64
  %r18 = and i64 %r17, 281474976710655
  %r19 = call i64 @js_path_join(i64 %r16, i64 %r18)
  %r20 = or i64 %r19, 9223090561878065152
  %r21 = bitcast i64 %r20 to double
  store double %r21, ptr %r4
  call void @js_shadow_slot_bind(i32 0, ptr %r4)
  call void @js_shadow_slot_set(i32 0, i64 %r20)
  %r23 = call i64 @js_process_cwd()
  %r24 = or i64 %r23, 9223090561878065152
  %r25 = bitcast i64 %r24 to double
  %r26 = load double, ptr @tray_ts_.str.6.handle
  %r27 = and i64 %r24, 281474976710655
  %r28 = bitcast double %r26 to i64
  %r29 = and i64 %r28, 281474976710655
  %r30 = call i64 @js_path_join(i64 %r27, i64 %r29)
  %r31 = or i64 %r30, 9223090561878065152
  %r32 = bitcast i64 %r31 to double
  %r33 = load double, ptr @tray_ts_.str.8.handle
  %r34 = and i64 %r31, 281474976710655
  %r35 = bitcast double %r33 to i64
  %r36 = and i64 %r35, 281474976710655
  %r37 = call i64 @js_path_join(i64 %r34, i64 %r36)
  %r38 = or i64 %r37, 9223090561878065152
  %r39 = bitcast i64 %r38 to double
  store double %r39, ptr %r22
  call void @js_shadow_slot_bind(i32 1, ptr %r22)
  call void @js_shadow_slot_set(i32 1, i64 %r38)
  %r41 = load double, ptr %r4
  %r42 = call i32 @js_fs_exists_sync(double %r41)
  %r43 = icmp ne i32 %r42, 0
  %r44 = select i1 %r43, i64 9222246136947933188, i64 9222246136947933187
  %r45 = bitcast i64 %r44 to double
  %r46 = call i32 @js_is_truthy(double %r45)
  %r47 = icmp ne i32 %r46, 0
  br i1 %r47, label %ternary.then.1, label %ternary.else.2

ternary.then.1:
  %r48 = load double, ptr %r4
  br label %ternary.merge.3

ternary.else.2:
  %r49 = load double, ptr %r22
  %r50 = call i32 @js_fs_exists_sync(double %r49)
  %r51 = icmp ne i32 %r50, 0
  %r52 = select i1 %r51, i64 9222246136947933188, i64 9222246136947933187
  %r53 = bitcast i64 %r52 to double
  %r54 = call i32 @js_is_truthy(double %r53)
  %r55 = icmp ne i32 %r54, 0
  br i1 %r55, label %ternary.then.4, label %ternary.else.5

ternary.merge.3:
  %r59 = phi double [ %r48, %ternary.then.1 ], [ %r58, %ternary.merge.6 ]
  store double %r59, ptr %r40
  call void @js_shadow_slot_bind(i32 2, ptr %r40)
  %r60 = bitcast double %r59 to i64
  call void @js_shadow_slot_set(i32 2, i64 %r60)
  call void @js_shadow_slot_set(i32 0, i64 0)
  call void @js_shadow_slot_set(i32 1, i64 0)
  %r61 = load double, ptr %r40
  store double %r61, ptr @perry_global_tray_ts__3
...
ternary.then.4:
  %r56 = load double, ptr %r22
  br label %ternary.merge.6

ternary.else.5:
  %r57 = load double, ptr @tray_ts_.str.9.handle
  br label %ternary.merge.6

ternary.merge.6:
  %r58 = phi double [ %r56, %ternary.then.4 ], [ %r57, %ternary.else.5 ]
  br label %ternary.merge.3
}

define void @__perry_init_strings_tray_ts_chunk0() {
entry.0:
  %r1 = call i64 @js_string_from_bytes(ptr @tray_ts_.str.0.bytes, i32 15)
  %r2 = call double @js_nanbox_string(i64 %r1)
  store double %r2, ptr @tray_ts_.str.0.handle
  %r3 = ptrtoint ptr @tray_ts_.str.0.handle to i64
  call void @js_gc_register_global_root(i64 %r3)
  %r4 = call i64 @js_string_from_bytes(ptr @tray_ts_.str.1.bytes, i32 6)
  %r5 = call double @js_nanbox_string(i64 %r4)
  store double %r5, ptr @tray_ts_.str.1.handle
  %r6 = ptrtoint ptr @tray_ts_.str.1.handle to i64
  call void @js_gc_register_global_root(i64 %r6)
  %r7 = call i64 @js_string_from_bytes(ptr @tray_ts_.str.2.bytes, i32 28)
  %r8 = call double @js_nanbox_string(i64 %r7)
  store double %r8, ptr @tray_ts_.str.2.handle
  %r9 = ptrtoint ptr @tray_ts_.str.2.handle to i64
  call void @js_gc_register_global_root(i64 %r9)
  %r10 = call i64 @js_string_from_bytes(ptr @tray_ts_.str.3.bytes, i32 22)
  %r11 = call double @js_nanbox_string(i64 %r10)
  store double %r11, ptr @tray_ts_.str.3.handle
  %r12 = ptrtoint ptr @tray_ts_.str.3.handle to i64
  call void @js_gc_register_global_root(i64 %r12)
  %r13 = call i64 @js_string_from_bytes(ptr @tray_ts_.str.4.bytes, i32 19)
  %r14 = call double @js_nanbox_string(i64 %r13)
  store double %r14, ptr @tray_ts_.str.4.handle
  %r15 = ptrtoint ptr @tray_ts_.str.4.handle to i64
  call void @js_gc_register_global_root(i64 %r15)
  %r16 = call i64 @js_string_from_bytes(ptr @tray_ts_.str.5.bytes, i32 46)
  %r17 = call double @js_nanbox_string(i64 %r16)
  store double %r17, ptr @tray_ts_.str.5.handle
  %r18 = ptrtoint ptr @tray_ts_.str.5.handle to i64
  call void @js_gc_register_global_root(i64 %r18)
  %r19 = call i64 @js_string_from_bytes(ptr @tray_ts_.str.6.bytes, i32 6)
  %r20 = call double @js_nanbox_string(i64 %r19)
  store double %r20, ptr @tray_ts_.str.6.handle
  %r21 = ptrtoint ptr @tray_ts_.str.6.handle to i64
  call void @js_gc_register_global_root(i64 %r21)
  %r22 = call i64 @js_string_from_bytes(ptr @tray_ts_.str.7.bytes, i32 8)
  %r23 = call double @js_nanbox_string(i64 %r22)
  store double %r23, ptr @tray_ts_.str.7.handle
  %r24 = ptrtoint ptr @tray_ts_.str.7.handle to i64
  call void @js_gc_register_global_root(i64 %r24)
  %r25 = call i64 @js_string_from_bytes(ptr @tray_ts_.str.8.bytes, i32 8)
  %r26 = call double @js_nanbox_string(i64 %r25)
  store double %r26, ptr @tray_ts_.str.8.handle
  %r27 = ptrtoint ptr @tray_ts_.str.8.handle to i64
  call void @js_gc_register_global_root(i64 %r27)
  %r28 = call i64 @js_string_from_bytes(ptr @tray_ts_.str.9.bytes, i32 0)
  %r29 = call double @js_nanbox_string(i64 %r28)
  store double %r29, ptr @tray_ts_.str.9.handle
  %r30 = ptrtoint ptr @tray_ts_.str.9.handle to i64
  call void @js_gc_register_global_root(i64 %r30)
  call void @js_register_function_name(ptr @__perry_wrap_perry_fn_tray_ts__initTray, ptr @.str.0, i32 8)
  call void @js_register_function_source(ptr @__perry_wrap_perry_fn_tray_ts__initTray, ptr @.str.1, i32 594)
  call void @js_register_function_source(ptr @perry_closure_tray_ts__2, ptr @.str.2, i32 72)
  call void @js_register_function_source(ptr @perry_closure_tray_ts__3, ptr @.str.3, i32 78)
  call void @js_register_function_source(ptr @perry_closure_tray_ts__1, ptr @.str.4, i32 54)
  call void @js_register_closure_arity(ptr @perry_closure_tray_ts__1, i32 0)
  call void @js_register_closure_arity(ptr @perry_closure_tray_ts__2, i32 0)
  call void @js_register_closure_arity(ptr @perry_closure_tray_ts__3, i32 0)
  call void @js_register_closure_length(ptr @perry_closure_tray_ts__1, i32 0)
  call void @js_register_closure_length(ptr @perry_closure_tray_ts__2, i32 0)
  call void @js_register_closure_length(ptr @perry_closure_tray_ts__3, i32 0)
  call void @js_register_closure_arrow_function(ptr @perry_closure_tray_ts__1)
  call void @js_register_closure_arrow_function(ptr @perry_closure_tray_ts__2)
  call void @js_register_closure_arrow_function(ptr @perry_closure_tray_ts__3)
  call void @js_register_closure_arity(ptr @__perry_wrap_perry_fn_tray_ts__initTray, i32 0)
  call void @js_register_closure_length(ptr @__perry_wrap_perry_fn_tray_ts__initTray, i32 0)
  call void @js_register_closure_strict_function(ptr @__perry_wrap_perry_fn_tray_ts__initTray)
  call void @js_register_closure_strict_function(ptr @perry_closure_tray_ts__1)
  call void @js_register_closure_strict_function(ptr @perry_closure_tray_ts__2)
  call void @js_register_closure_strict_function(ptr @perry_closure_tray_ts__3)
  ret void
}

define void @__perry_init_strings_tray_ts() {
entry.0:
  call void @__perry_init_strings_tray_ts_chunk0()
  ret void
}
