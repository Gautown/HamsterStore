...
@accelerator_ts_.str.0.bytes = private unnamed_addr constant [19 x i8] c"./accelerator-core\00"
@accelerator_ts_.str.1.bytes = private unnamed_addr constant [21 x i8] c"isAcceleratorEnabled\00"
@accelerator_ts_.str.2.bytes = private unnamed_addr constant [4 x i8] c"GET\00"
@accelerator_ts_.str.3.bytes = private unnamed_addr constant [7 x i8] c"signal\00"
@.str.0 = private unnamed_addr constant [17 x i8] c"fetchAccelerated\00"
@.str.1 = private unnamed_addr constant [500 x i8] c"async function fetchAccelerated(\0A  input: string,\0A  init?: RequestInit\0A): Promise<Response> {\0A  // \E5\8A\A0\E9\80\9F\E5\99\A8\E6\9C\AA\E5\90\AF\E7\94\A8 \E2\86\92 \E7\9B\B4\E6\8E\A5 fetch\0A  const { isAcceleratorEnabled } = await import(\22./accelerator-core\22);\0A  if (!isAcceleratorEnabled()) return fetch(input, init);\0A\0A  // \E5\B8\A6\E8\B6\85\E6\97\B6\E7\9A\84 fetch\0A  const ctrl = new AbortController();\0A  const timer = setTimeout(() => ctrl.abort(), 15000);\0A  try {\0A    return await fetch(input, { ...init, signal: ctrl.signal });\0A  } finally {\0A    clearTimeout(timer);\0A  }\0A}\00"
@.str.2 = private unnamed_addr constant [19 x i8] c"() => ctrl.abort()\00"
...
@__perry_ns_accelerator_core_ts = external global double
@__perry_init_done_accelerator_ts = internal global i8 0
@accelerator_ts_.str.0.handle = internal global double 0.0
@accelerator_ts_.str.1.handle = internal global double 0.0
@accelerator_ts_.str.2.handle = internal global double 0.0
@accelerator_ts_.str.3.handle = internal global double 0.0
...
define double @perry_fn_accelerator_ts__fetchAccelerated(double %arg0, double %arg1) {
entry.0:
  %r1 = alloca i64
  ...
  call void @js_shadow_slot_bind(i32 1, ptr %r18)
  ...
  call void @js_shadow_slot_bind(i32 7, ptr %r24)
  ...
  %r40 = load double, ptr %r3
  %r41 = bitcast double %r40 to i64
  %r42 = load i64, ptr %r4
  %r43 = load i64, ptr %r8
  %r44 = load i64, ptr %r10
  %r45 = load i64, ptr %r12
  %r46 = load i64, ptr %r14
  %r47 = load i64, ptr %r16
  %r48 = load i64, ptr %r18
  %r49 = load i64, ptr %r20
  %r50 = load i64, ptr %r22
  %r51 = load i64, ptr %r24
  %r52 = load i64, ptr %r26
  %r53 = call i64 @js_closure_alloc(ptr @perry_closure_accelerator_ts__3, i32 12)
  call void @js_closure_set_capture_bits(i64 %r53, i32 0, i64 %r41)
  call void @js_closure_set_capture_bits(i64 %r53, i32 1, i64 %r42)
  call void @js_closure_set_capture_bits(i64 %r53, i32 2, i64 %r43)
  call void @js_closure_set_capture_bits(i64 %r53, i32 3, i64 %r44)
  call void @js_closure_set_capture_bits(i64 %r53, i32 4, i64 %r45)
  call void @js_closure_set_capture_bits(i64 %r53, i32 5, i64 %r46)
  call void @js_closure_set_capture_bits(i64 %r53, i32 6, i64 %r47)
  call void @js_closure_set_capture_bits(i64 %r53, i32 7, i64 %r48)
  call void @js_closure_set_capture_bits(i64 %r53, i32 8, i64 %r49)
  call void @js_closure_set_capture_bits(i64 %r53, i32 9, i64 %r50)
  call void @js_closure_set_capture_bits(i64 %r53, i32 10, i64 %r51)
  call void @js_closure_set_capture_bits(i64 %r53, i32 11, i64 %r52)
  %r54 = or i64 %r53, 9222527611924643840
  %r55 = bitcast i64 %r54 to double
  store double %r55, ptr %r39
  call void @js_shadow_slot_bind(i32 8, ptr %r39)
  call void @js_shadow_slot_set(i32 8, i64 %r54)
...
define double @perry_closure_accelerator_ts__3(i64 %this_closure, double %arg20, double %arg21) #1 {
entry.0:
  %r3 = alloca double
...
try.catch.2:
  ...
  %r311 = call double @js_get_exception()
  call void @js_clear_exception()
  store double %r311, ptr %r312
  %r313 = load double, ptr %r2
  %r314 = bitcast double %r313 to i64
  %r315 = icmp eq i64 %r314, 9222246136947933188
  br i1 %r315, label %if.then.69, label %if.else.70

try.finally.3:
  %r328 = call double @js_iter_result_get_done()
  %r329 = call i32 @js_is_truthy(double %r328)
  %r330 = icmp ne i32 %r329, 0
  br i1 %r330, label %if.then.72, label %if.else.73
...
dowhile.cond.5:
  %r308 = select i1 false, i64 9222246136947933188, i64 9222246136947933187
  %r309 = bitcast i64 %r308 to double
  %r310 = icmp eq i64 %r308, 9222246136947933188
  br i1 %r310, label %dowhile.body.4, label %dowhile.exit.6
...
if.else.8:
  ...
  %r17 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 10)
  %r18 = bitcast double %r16 to i64
  call void @js_box_set_bits(i64 %r17, i64 %r18)
  call void @js_write_barrier(i64 %r17, i64 %r18)
  %r19 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 9)
...
while.body.14:
  %r26 = call ptr @js_try_push()
  %r27 = call i32 @_setjmp(ptr %r26, ptr null) #0
  %r28 = icmp ne i32 %r27, 0
  br i1 %r28, label %try.catch.17, label %try.body.16

while.exit.15:
  br label %if.merge.9

try.body.16:
  %r29 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 8)
  %r30 = call i32 @js_i32_box_get(i64 %r29)
  %r31 = icmp eq i32 %r30, 0
  br i1 %r31, label %if.then.19, label %if.else.20

try.catch.17:
  call void @js_try_end()
  %r284 = call double @js_get_exception()
  call void @js_clear_exception()
  store double %r284, ptr %r285
  %r286 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 9)
  %r287 = zext i1 true to i32
  call void @js_bool_box_set(i64 %r286, i32 %r287)
  %r288 = select i1 true, i64 9222246136947933188, i64 9222246136947933187
  %r289 = bitcast i64 %r288 to double
  %r290 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 8)
  %r291 = call i32 @js_i32_box_get(i64 %r290)
  %r292 = icmp sgt i32 %r291, 2
  %r293 = select i1 %r292, i64 9222246136947933188, i64 9222246136947933187
  %r294 = bitcast i64 %r293 to double
  %r295 = icmp eq i64 %r293, 9222246136947933188
  br i1 %r295, label %logical.then.64, label %logical.merge.65
...
if.then.19:
  ...
  %r33 = call i64 @js_box_get_bits(i64 %r32)
  %r34 = bitcast i64 %r33 to double
  %r35 = bitcast double 0x7FFC000000000001 to i64
  %r36 = icmp eq i64 %r33, %r35
  %r37 = select i1 %r36, i64 9222246136947933188, i64 9222246136947933187
  %r38 = bitcast i64 %r37 to double
  %r39 = icmp eq i64 %r37, 9222246136947933188
  br i1 %r39, label %if.then.22, label %if.else.23

if.else.20:
  br label %if.merge.21

if.merge.21:
  %r51 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 8)
  %r52 = call i32 @js_i32_box_get(i64 %r51)
  %r53 = icmp eq i32 %r52, 1
  br i1 %r53, label %if.then.25, label %if.else.26

if.then.22:
  %r40 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 1)
  %r41 = bitcast double 0x7FFC000000000001 to i64
  call void @js_box_set_bits(i64 %r40, i64 %r41)
  call void @js_write_barrier(i64 %r40, i64 %r41)
...
if.merge.24:
  %r42 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 8)
  call void @js_i32_box_set(i64 %r42, i32 1)
  %r43 = sitofp i32 1 to double
  %r44 = load double, ptr @accelerator_ts_.str.0.handle
  %r45 = call double @js_module_dynamic_import_apply_hooks(double %r44)
  call void @accelerator_core_ts__init()
  %r46 = load double, ptr @__perry_ns_accelerator_core_ts
  %r47 = call i64 @js_promise_resolved(double %r46)
  %r48 = or i64 %r47, 9222527611924643840
  %r49 = bitcast i64 %r48 to double
  %r50 = call double @js_iter_result_set(double %r49, i32 0)
  call void @js_try_end()
  br label %dowhile.exit.6

if.then.25:
  %r54 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 10)
  %r55 = call i64 @js_box_get_bits(i64 %r54)
  %r56 = bitcast i64 %r55 to double
  %r57 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 7)
  call void @js_box_set_bits(i64 %r57, i64 %r55)
  call void @js_write_barrier(i64 %r57, i64 %r55)
  %r58 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 7)
  %r59 = call i64 @js_box_get_bits(i64 %r58)
  %r60 = bitcast i64 %r59 to double
  %r61 = call double @js_require_object_coercible(double %r60)
  %r62 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 2)
  %r63 = bitcast double %r61 to i64
  call void @js_box_set_bits(i64 %r62, i64 %r63)
  call void @js_write_barrier(i64 %r62, i64 %r63)
  %r64 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 2)
  %r65 = call i64 @js_box_get_bits(i64 %r64)
  %r66 = bitcast i64 %r65 to double
  %r67 = and i64 %r65, 281474976710655
  %r68 = load double, ptr @accelerator_ts_.str.1.handle
  ...
  br i1 %r72, label %pget.recv_sso.28, label %pget.check_class_ref.34

if.else.26:
  br label %if.merge.27

if.merge.27:
  %r172 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 8)
  %r173 = call i32 @js_i32_box_get(i64 %r172)
  %r174 = icmp eq i32 %r173, 2
  br i1 %r174, label %if.then.43, label %if.else.44

pget.recv_sso.28:
  %r118 = call double @js_object_get_field_by_name_f64(i64 %r65, i64 %r70)
  br label %pget.recv_merge.32

pget.recv_ok.29:
  call void @js_typed_feedback_observe_property_get(i64 5673306980861607936, i64 %r67, i64 %r70)
  %r77 = icmp ugt i64 %r67, 1048575
  %r78 = ptrtoint ptr @perry_ic_1 to i64
  ...
  %r98 = getelementptr i64, ptr @perry_ic_1, i64 0
  %r99 = load i64, ptr %r98
  %r100 = icmp eq i64 %r97, %r99
  %r101 = icmp ne i64 %r97, 0
  %r102 = and i1 %r94, %r100
  %r103 = and i1 %r102, %r101
  br i1 %r103, label %pic.hit.35, label %pic.miss.36

pget.recv_bad.30:
  %r113 = icmp eq i64 %r65, 9222246136947933185
  %r114 = icmp eq i64 %r65, 9222246136947933186
  %r115 = or i1 %r113, %r114
  br i1 %r115, label %pget.throw_nullish.38, label %pget.recv_undef_return.39

pget.recv_class_ref.31:
  %r76 = call double @js_typed_feedback_object_get_field_by_name_f64(i64 5673306980861607936, i64 %r65, i64 %r70)
  br label %pget.recv_merge.32

pget.recv_merge.32:
  %r119 = phi double [ %r112, %pic.merge.37 ], [ %r117, %pget.recv_undef_return.39 ], [ %r118, %pget.recv_sso.28 ], [ %r76, %pget.recv_class_ref.31 ]
  %r120 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 3)
  %r121 = bitcast double %r119 to i64
  call void @js_box_set_bits(i64 %r120, i64 %r121)
  call void @js_write_barrier(i64 %r120, i64 %r121)
  %r122 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 3)
  %r123 = call i64 @js_box_get_bits(i64 %r122)
  %r124 = bitcast i64 %r123 to double
  %r125 = call double @js_implicit_this_set(double 0x7FFC000000000001)
  %r126 = call i64 @js_closure_unbox_callee_checked(double %r124)
  %r127 = call double @js_closure_call0(i64 %r126)
  %r128 = call double @js_implicit_this_set(double %r125)
  %r129 = call i32 @js_is_truthy(double %r127)
  %r130 = icmp ne i32 %r129, 0
  %r131 = xor i1 %r130, true
  %r132 = select i1 %r131, i64 9222246136947933188, i64 9222246136947933187
  %r133 = bitcast i64 %r132 to double
  %r134 = icmp eq i64 %r132, 9222246136947933188
  br i1 %r134, label %if.then.40, label %if.else.41

pget.check_ptr.33:
  br i1 %r75, label %pget.recv_ok.29, label %pget.recv_bad.30

pget.check_class_ref.34:
  br i1 %r73, label %pget.recv_class_ref.31, label %pget.check_ptr.33

pic.hit.35:
  call void @js_typed_feedback_record_guard_pass(i64 5673306980861607936)
  %r104 = getelementptr i64, ptr @perry_ic_1, i64 1
...
pic.miss.36:
  call void @js_typed_feedback_record_guard_fail(i64 5673306980861607936)
  call void @js_typed_feedback_record_fallback_call(i64 5673306980861607936)
  %r111 = call double @js_object_get_field_ic_miss(i64 %r67, i64 %r70, ptr @perry_ic_1)
  br label %pic.merge.37

pic.merge.37:
  %r112 = phi double [ %r110, %pic.hit.35 ], [ %r111, %pic.miss.36 ]
  br label %pget.recv_merge.32

pget.throw_nullish.38:
  %r116 = zext i1 %r114 to i32
  call void @js_throw_type_error_property_access(i32 %r116, ptr @accelerator_ts_.str.1.bytes, i64 20)
  unreachable

pget.recv_undef_return.39:
  %r117 = call double @js_object_get_field_by_name_f64(i64 %r65, i64 %r70)
  br label %pget.recv_merge.32

if.then.40:
  %r135 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 9)
  %r136 = zext i1 true to i32
  call void @js_bool_box_set(i64 %r135, i32 %r136)
  %r137 = select i1 true, i64 9222246136947933188, i64 9222246136947933187
  %r138 = bitcast i64 %r137 to double
  %r139 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 0)
  %r140 = bitcast i64 %r139 to double
  %r141 = load double, ptr @accelerator_ts_.str.2.handle
  %r142 = call i64 @js_object_alloc(i32 0, i32 0)
  %r143 = or i64 %r142, 9222527611924643840
  %r144 = bitcast i64 %r143 to double
  %r145 = call i64 @js_fetch_headers_to_json(double %r144)
  %r146 = and i64 %r139, 281474976710655
  %r147 = bitcast double %r141 to i64
  %r148 = and i64 %r147, 281474976710655
  %r149 = bitcast double 0x7FFC000000000001 to i64
  %r150 = and i64 %r149, 281474976710655
  %r151 = call i64 @js_fetch_with_options(i64 %r146, i64 %r148, i64 %r150, i64 %r145)
  %r152 = or i64 %r151, 9222527611924643840
  %r153 = bitcast i64 %r152 to double
  %r154 = call double @js_iter_result_set(double %r153, i32 1)
  call void @js_try_end()
  br label %dowhile.exit.6
...
if.merge.42:
  %r155 = call i64 @js_abort_controller_new()
  %r156 = or i64 %r155, 9222527611924643840
  %r157 = bitcast i64 %r156 to double
  %r158 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 4)
  call void @js_box_set_bits(i64 %r158, i64 %r156)
  call void @js_write_barrier(i64 %r158, i64 %r156)
  %r159 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 4)
  %r161 = getelementptr i64, ptr %r160, i64 0
  store i64 %r159, ptr %r161
  %r162 = call i64 @js_closure_alloc_with_captures_singleton(ptr @perry_closure_accelerator_ts__1, i32 1, ptr %r160)
  %r163 = or i64 %r162, 9222527611924643840
  %r164 = bitcast i64 %r163 to double
  %r165 = call i64 @js_timer_validate_callback(double %r164, i32 0)
  %r166 = call i64 @js_set_timeout_callback(i64 %r165, double 15000.0)
  %r167 = or i64 %r166, 9222527611924643840
  %r168 = bitcast i64 %r167 to double
  %r169 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 5)
  call void @js_box_set_bits(i64 %r169, i64 %r167)
  call void @js_write_barrier(i64 %r169, i64 %r167)
  %r170 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 8)
  call void @js_i32_box_set(i64 %r170, i32 2)
  %r171 = sitofp i32 2 to double
  call void @js_try_end()
  br label %while.cond.13

if.then.43:
  %r175 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 8)
  call void @js_i32_box_set(i64 %r175, i32 3)
  %r176 = sitofp i32 3 to double
  %r177 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 0)
  %r178 = bitcast i64 %r177 to double
  %r179 = load double, ptr @accelerator_ts_.str.2.handle
  %r180 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 4)
  %r181 = call i64 @js_box_get_bits(i64 %r180)
  %r182 = bitcast i64 %r181 to double
  %r183 = and i64 %r181, 281474976710655
  %r184 = load double, ptr @accelerator_ts_.str.3.handle
  %r185 = bitcast double %r184 to i64
  %r186 = and i64 %r185, 281474976710655
  %r187 = lshr i64 %r181, 48
  %r188 = icmp eq i64 %r187, 32761
  %r189 = icmp eq i64 %r187, 32766
  %r190 = and i64 %r187, 65533
  %r191 = icmp eq i64 %r190, 32765
  br i1 %r188, label %pget.recv_sso.46, label %pget.check_class_ref.52

if.else.44:
  br label %if.merge.45

if.merge.45:
  %r250 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 8)
  %r251 = call i32 @js_i32_box_get(i64 %r250)
  %r252 = icmp eq i32 %r251, 3
  br i1 %r252, label %if.then.58, label %if.else.59

pget.recv_sso.46:
  %r234 = call double @js_object_get_field_by_name_f64(i64 %r181, i64 %r186)
  br label %pget.recv_merge.50

pget.recv_ok.47:
  call void @js_typed_feedback_observe_property_get(i64 5673306980861607938, i64 %r183, i64 %r186)
  %r193 = icmp ugt i64 %r183, 1048575
  %r194 = ptrtoint ptr @perry_ic_3 to i64
  %r195 = select i1 %r193, i64 %r183, i64 %r194
  %r196 = sub i64 %r195, 8
  %r197 = inttoptr i64 %r196 to ptr
  %r198 = load i8, ptr %r197
  %r199 = icmp eq i8 %r198, 2
  %r200 = and i1 %r193, %r199
  %r201 = add i64 %r195, 12
  %r202 = inttoptr i64 %r201 to ptr
  %r203 = load i32, ptr %r202
  %r204 = icmp eq i32 %r203, 1129268819
  %r205 = xor i1 %r204, true
  %r206 = and i1 %r200, %r205
  %r207 = inttoptr i64 %r195 to ptr
  %r208 = load i32, ptr %r207
  %r209 = icmp eq i32 %r208, 1
  %r210 = and i1 %r206, %r209
  %r211 = add i64 %r195, 16
  %r212 = inttoptr i64 %r211 to ptr
  %r213 = load i64, ptr %r212
  %r214 = getelementptr i64, ptr @perry_ic_3, i64 0
  %r215 = load i64, ptr %r214
  %r216 = icmp eq i64 %r213, %r215
  %r217 = icmp ne i64 %r213, 0
  %r218 = and i1 %r210, %r216
  %r219 = and i1 %r218, %r217
  br i1 %r219, label %pic.hit.53, label %pic.miss.54

pget.recv_bad.48:
  %r229 = icmp eq i64 %r181, 9222246136947933185
  %r230 = icmp eq i64 %r181, 9222246136947933186
  %r231 = or i1 %r229, %r230
  br i1 %r231, label %pget.throw_nullish.56, label %pget.recv_undef_return.57

pget.recv_class_ref.49:
  %r192 = call double @js_typed_feedback_object_get_field_by_name_f64(i64 5673306980861607938, i64 %r181, i64 %r186)
  br label %pget.recv_merge.50

pget.recv_merge.50:
  %r235 = phi double [ %r228, %pic.merge.55 ], [ %r233, %pget.recv_undef_return.57 ], [ %r234, %pget.recv_sso.46 ], [ %r192, %pget.recv_class_ref.49 ]
  %r236 = call i64 @js_object_alloc(i32 0, i32 0)
  %r237 = or i64 %r236, 9222527611924643840
  %r238 = bitcast i64 %r237 to double
  %r239 = call i64 @js_fetch_headers_to_json(double %r238)
  %r240 = bitcast double %r178 to i64
  %r241 = and i64 %r240, 281474976710655
  %r242 = bitcast double %r179 to i64
  %r243 = and i64 %r242, 281474976710655
  %r244 = bitcast double 0x7FFC000000000001 to i64
  %r245 = and i64 %r244, 281474976710655
  call void @js_fetch_set_pending_signal(double %r235)
  %r246 = call i64 @js_fetch_with_options(i64 %r241, i64 %r243, i64 %r245, i64 %r239)
  %r247 = or i64 %r246, 9222527611924643840
  %r248 = bitcast i64 %r247 to double
  %r249 = call double @js_iter_result_set(double %r248, i32 0)
  call void @js_try_end()
  br label %dowhile.exit.6

pget.check_ptr.51:
  br i1 %r191, label %pget.recv_ok.47, label %pget.recv_bad.48

pget.check_class_ref.52:
  br i1 %r189, label %pget.recv_class_ref.49, label %pget.check_ptr.51

pic.hit.53:
  call void @js_typed_feedback_record_guard_pass(i64 5673306980861607938)
  %r220 = getelementptr i64, ptr @perry_ic_3, i64 1
  %r221 = load i64, ptr %r220
  %r222 = shl i64 %r221, 3
  %r223 = add i64 %r183, 24
  %r224 = add i64 %r223, %r222
  %r225 = inttoptr i64 %r224 to ptr
  %r226 = load double, ptr %r225
  br label %pic.merge.55

pic.miss.54:
  call void @js_typed_feedback_record_guard_fail(i64 5673306980861607938)
  call void @js_typed_feedback_record_fallback_call(i64 5673306980861607938)
  %r227 = call double @js_object_get_field_ic_miss(i64 %r183, i64 %r186, ptr @perry_ic_3)
  br label %pic.merge.55

pic.merge.55:
  %r228 = phi double [ %r226, %pic.hit.53 ], [ %r227, %pic.miss.54 ]
  br label %pget.recv_merge.50

pget.throw_nullish.56:
  %r232 = zext i1 %r230 to i32
  call void @js_throw_type_error_property_access(i32 %r232, ptr @accelerator_ts_.str.3.bytes, i64 6)
  unreachable

pget.recv_undef_return.57:
  %r233 = call double @js_object_get_field_by_name_f64(i64 %r181, i64 %r186)
  br label %pget.recv_merge.50

if.then.58:
  %r253 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 10)
  %r254 = call i64 @js_box_get_bits(i64 %r253)
  %r255 = bitcast i64 %r254 to double
  %r256 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 6)
  call void @js_box_set_bits(i64 %r256, i64 %r254)
  call void @js_write_barrier(i64 %r256, i64 %r254)
  %r257 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 5)
  %r258 = call i64 @js_box_get_bits(i64 %r257)
  %r259 = bitcast i64 %r258 to double
  call void @js_clear_timeout_value(double %r259)
  %r260 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 9)
  %r261 = zext i1 true to i32
  call void @js_bool_box_set(i64 %r260, i32 %r261)
  %r262 = select i1 true, i64 9222246136947933188, i64 9222246136947933187
  %r263 = bitcast i64 %r262 to double
  %r264 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 6)
  %r265 = call i64 @js_box_get_bits(i64 %r264)
  %r266 = bitcast i64 %r265 to double
  %r267 = call double @js_iter_result_set(double %r266, i32 1)
  call void @js_try_end()
  br label %dowhile.exit.6
...
if.merge.60:
  %r268 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 8)
  %r269 = call i32 @js_i32_box_get(i64 %r268)
  %r270 = icmp eq i32 %r269, 4
  br i1 %r270, label %if.then.61, label %if.else.62

if.then.61:
  %r271 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 5)
  %r272 = call i64 @js_box_get_bits(i64 %r271)
  %r273 = bitcast i64 %r272 to double
  call void @js_clear_timeout_value(double %r273)
  %r274 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 9)
  %r275 = zext i1 true to i32
  call void @js_bool_box_set(i64 %r274, i32 %r275)
  %r276 = select i1 true, i64 9222246136947933188, i64 9222246136947933187
  %r277 = bitcast i64 %r276 to double
  %r278 = call double @js_iter_result_set(double 0x7FFC000000000001, i32 1)
  call void @js_try_end()
  br label %dowhile.exit.6
...
if.merge.63:
  %r279 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 9)
  %r280 = zext i1 true to i32
  call void @js_bool_box_set(i64 %r279, i32 %r280)
  %r281 = select i1 true, i64 9222246136947933188, i64 9222246136947933187
  %r282 = bitcast i64 %r281 to double
  %r283 = call double @js_iter_result_set(double 0x7FFC000000000001, i32 1)
  call void @js_try_end()
  br label %dowhile.exit.6

logical.then.64:
  %r296 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 8)
  %r297 = call i32 @js_i32_box_get(i64 %r296)
  %r298 = icmp sle i32 %r297, 4
  %r299 = select i1 %r298, i64 9222246136947933188, i64 9222246136947933187
  %r300 = bitcast i64 %r299 to double
  br label %logical.merge.65

logical.merge.65:
  %r301 = phi double [ %r294, %try.catch.17 ], [ %r300, %logical.then.64 ]
  %r302 = bitcast double %r301 to i64
  %r303 = icmp eq i64 %r302, 9222246136947933188
  br i1 %r303, label %if.then.66, label %if.else.67

if.then.66:
  %r304 = call i64 @js_closure_get_capture_bits(i64 %this_closure, i32 5)
  %r305 = call i64 @js_box_get_bits(i64 %r304)
  %r306 = bitcast i64 %r305 to double
  call void @js_clear_timeout_value(double %r306)
...
if.merge.68:
  %r307 = load double, ptr %r285
  call void @js_throw(double %r307)
  unreachable

if.then.69:
  %r316 = load double, ptr %r312
  %r317 = call i64 @js_promise_rejected(double %r316)
  %r318 = or i64 %r317, 9222527611924643840
...
if.merge.71:
  %r320 = load double, ptr %r3
  %r321 = load double, ptr %r312
  %r322 = select i1 true, i64 9222246136947933188, i64 9222246136947933187
  %r323 = bitcast i64 %r322 to double
  %r324 = call double @js_implicit_this_set(double 0x7FFC000000000001)
  %r325 = call i64 @js_closure_unbox_callee_checked(double %r320)
  %r326 = call double @js_closure_call2(i64 %r325, double %r321, double %r323)
  %r327 = call double @js_implicit_this_set(double %r324)
  ret double %r326

if.then.72:
  %r331 = call double @js_iter_result_get_value()
  %r332 = load double, ptr %r3
  %r333 = bitcast double %r332 to i64
  %r334 = and i64 %r333, 281474976710655
  %r335 = call i64 @js_async_step_done(double %r331, i64 %r334)
...
if.merge.74:
  %r338 = call double @js_iter_result_get_value()
  %r339 = load double, ptr %r3
  %r340 = bitcast double %r339 to i64
  %r341 = and i64 %r340, 281474976710655
  %r342 = call i64 @js_async_step_chain(double %r338, i64 %r341)
  %r343 = or i64 %r342, 9222527611924643840
  %r344 = bitcast i64 %r343 to double
  ret double %r344
}

define double @perry_closure_accelerator_ts__1(i64 %this_closure) {
entry.0:
  ...
  call void @js_abort_controller_abort(i64 %r4)
  ret double 0x7FFC000000000001
}

define double @__perry_wrap_perry_fn_accelerator_ts__fetchAccelerated(i64 %this_closure, double %a0, double %a1) {
entry.0:
...
define void @accelerator_ts__init() {
entry.0:
  %r1 = load i8, ptr @__perry_init_done_accelerator_ts
  %r2 = icmp ne i8 %r1, 0
...
guard.do.2:
  store i8 1, ptr @__perry_init_done_accelerator_ts
  call void @accelerator_core_ts__init()
  call void @accelerator_ts__init_body()
  ret void
}

define external void @accelerator_ts__init_body() {
entry.0:
  call void @js_gc_write_barriers_emitted(i32 1)
  call void @__perry_init_strings_accelerator_ts()
  ret void
}

define void @__perry_init_strings_accelerator_ts_chunk0() {
entry.0:
  %r1 = call i64 @js_string_from_bytes(ptr @accelerator_ts_.str.0.bytes, i32 18)
  %r2 = call double @js_nanbox_string(i64 %r1)
  store double %r2, ptr @accelerator_ts_.str.0.handle
  %r3 = ptrtoint ptr @accelerator_ts_.str.0.handle to i64
  call void @js_gc_register_global_root(i64 %r3)
  %r4 = call i64 @js_string_from_bytes(ptr @accelerator_ts_.str.1.bytes, i32 20)
  %r5 = call double @js_nanbox_string(i64 %r4)
  store double %r5, ptr @accelerator_ts_.str.1.handle
  %r6 = ptrtoint ptr @accelerator_ts_.str.1.handle to i64
  call void @js_gc_register_global_root(i64 %r6)
  %r7 = call i64 @js_string_from_bytes(ptr @accelerator_ts_.str.2.bytes, i32 3)
  %r8 = call double @js_nanbox_string(i64 %r7)
  store double %r8, ptr @accelerator_ts_.str.2.handle
  %r9 = ptrtoint ptr @accelerator_ts_.str.2.handle to i64
  call void @js_gc_register_global_root(i64 %r9)
  %r10 = call i64 @js_string_from_bytes(ptr @accelerator_ts_.str.3.bytes, i32 6)
  %r11 = call double @js_nanbox_string(i64 %r10)
  store double %r11, ptr @accelerator_ts_.str.3.handle
  %r12 = ptrtoint ptr @accelerator_ts_.str.3.handle to i64
  call void @js_gc_register_global_root(i64 %r12)
  call void @js_register_function_name(ptr @__perry_wrap_perry_fn_accelerator_ts__fetchAccelerated, ptr @.str.0, i32 16)
  call void @js_register_function_source(ptr @__perry_wrap_perry_fn_accelerator_ts__fetchAccelerated, ptr @.str.1, i32 499)
  call void @js_register_function_source(ptr @perry_closure_accelerator_ts__1, ptr @.str.2, i32 18)
  call void @js_register_closure_arity(ptr @perry_closure_accelerator_ts__1, i32 0)
  call void @js_register_closure_arity(ptr @perry_closure_accelerator_ts__3, i32 2)
  call void @js_register_closure_length(ptr @perry_closure_accelerator_ts__1, i32 0)
  call void @js_register_closure_length(ptr @perry_closure_accelerator_ts__3, i32 2)
  call void @js_register_closure_arrow_function(ptr @perry_closure_accelerator_ts__1)
  call void @js_register_closure_arity(ptr @__perry_wrap_perry_fn_accelerator_ts__fetchAccelerated, i32 2)
  call void @js_register_closure_length(ptr @__perry_wrap_perry_fn_accelerator_ts__fetchAccelerated, i32 1)
  call void @js_register_closure_async_function(ptr @__perry_wrap_perry_fn_accelerator_ts__fetchAccelerated)
  call void @js_register_closure_strict_function(ptr @__perry_wrap_perry_fn_accelerator_ts__fetchAccelerated)
  call void @js_register_closure_strict_function(ptr @perry_closure_accelerator_ts__1)
  call void @js_register_closure_strict_function(ptr @perry_closure_accelerator_ts__3)
  ret void
}

define void @__perry_init_strings_accelerator_ts() {
entry.0:
  call void @__perry_init_strings_accelerator_ts_chunk0()
  ret void
}
